...
Public Class frm_consultar_BITARADI
...
#Region "MENU"
    ...
    Private Sub cmdCONSULTAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCONSULTAR.Click
        ...
        Dim boLEVAESTA As Boolean = objVerifica.fun_Verificar_Dato_Lleno(Me.cboLIRAESTA)

        If boLEVANUDO = True And _
           boLEVAESTA = True Then

            Dim inId_Reg As New frm_BITARADI(Me.cboMUDENUDO.SelectedValue, Me.cboLIRAESTA.SelectedValue)
