...
Public Class frm_bitacora_pendientes_liquidar_RESOCONS

    '============================================
    '*** RESOLUCIONES PENDIENTES POR LIQUIDAR ***
    '============================================
    ...
    Private Sub pro_ReconsultarResolucionDeConservacion()
        ...
        Try
            ...
            If boCONSULTA_BITACORA = False Then
                Me.BindingSource_RESOCONS_1.DataSource = objdatos.fun_Consultar_RESOCONS_X_BITACORA("ac", False)
