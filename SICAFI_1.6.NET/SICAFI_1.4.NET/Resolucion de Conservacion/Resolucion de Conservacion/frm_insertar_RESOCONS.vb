...
Public Class frm_insertar_RESOCONS

    '=============================================
    '*** INSERTAR RESOLUCIONES DE CONSERVACION ***
    '=============================================
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_RESOCONS(Me.txtRECONURE, Me.txtRECOFERE)
            ...
            If boLLAVEPRIMARIA = True And _
               ...
               boLIRAFERA = True Then

                If Trim(Me.txtRECOOBSE.Text) <> "" Then
                    Me.txtRECOOBSE.Text = " Nota ingresada por " & vp_usuario & " " & fun_fecha() & " : " & Trim(Me.txtRECOOBSE.Text) & ". "
                End If

                Me.txtRECOSECU.Text = CStr(fun_NumeroDeSecuenciaDeRegistro())

                Dim objdatos22 As New cla_RESOCONS

                If (objdatos22.fun_Insertar_RESOCONS(Me.txtRECOSECU.Text, _
...
#Region "GotFocus"
    ...
    Private Sub txt_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtRECONURE.GotFocus, txtRECOFERE.GotFocus, txtRECONURA.GotFocus, txtRECOFERA.GotFocus, txtRECODESC.GotFocus, txtRECOOBSE.GotFocus, txtRECOFEES.GotFocus, nudRECOUNID.GotFocus
