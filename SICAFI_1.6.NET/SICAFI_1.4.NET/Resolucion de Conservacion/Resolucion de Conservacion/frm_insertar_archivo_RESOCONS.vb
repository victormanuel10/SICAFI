...
Public Class frm_insertar_archivo_RESOCONS

    '===================================================
    '*** INSERTAR ARCHIVO RESOLUCION DE CONSERVACION ***
    '===================================================
...
#Region "CONSTRUCTOR"
    ...
    Public Sub New(ByVal stRECONURE As String, _
                   ByVal stRECOFERE As String)

        vl_stRECONURE = stRECONURE
        vl_stRECOFERE = stRECOFERE
    ...
    Private Function fun_consultarRutaDestino() As String
        ...
        Try
            ...
            If tblRutas.Rows.Count > 0 Then
                ...
                ' directorio pricipal
                stRuta = Trim(tblRutas.Rows(0).Item("RUTARUTA")) & "\" & vl_stRECONURE & "-" & vl_stRECOFERE & "\" & Me.lstLISTADO_DOCUMENTOS.SelectedItem
