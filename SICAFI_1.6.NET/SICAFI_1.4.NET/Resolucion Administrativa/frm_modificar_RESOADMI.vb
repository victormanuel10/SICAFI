...
Public Class frm_modificar_RESOADMI

    '==========================================
    '*** MODIFICAR RESOLUCION ADMINISTRADOR ***
    '==========================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            Dim objdatos8 As New cla_RESOADMI
            Dim tbl As New DataTable

            tbl = objdatos8.fun_Buscar_ID_RESOADMI(inID_REGISTRO)

            If tbl.Rows.Count > 0 Then

                Dim objdatos2 As New cla_CLASIFICACION

                Me.cboREADCLAS.DataSource = objdatos2.fun_Consultar_CAMPOS_MANT_CLASIFICACION
                Me.cboREADCLAS.DisplayMember = "CLASDESC"
                Me.cboREADCLAS.ValueMember = "CLASCODI"

                Me.cboREADCLAS.SelectedValue = tbl.Rows(0).Item("READCLAS")

                Me.txtREADNURE.Text = Trim(tbl.Rows(0).Item("READNURE"))
                Me.txtREADFERE.Text = Trim(tbl.Rows(0).Item("READFERE"))

                Dim objdatos55 As New cla_CLASSECT

                Me.cboREADCLSE.DataSource = objdatos55.fun_Consultar_CAMPOS_MANT_CLASSECT
                Me.cboREADCLSE.DisplayMember = "CLSEDESC"
                Me.cboREADCLSE.ValueMember = "CLSECODI"

                Me.cboREADCLSE.SelectedValue = tbl.Rows(0).Item("READCLSE")

                Dim objdatos5 As New cla_VIGENCIA

                Me.cboREADVIRE.DataSource = objdatos5.fun_Consultar_CAMPOS_VIGENCIA
                Me.cboREADVIRE.DisplayMember = "VIGEDESC"
                Me.cboREADVIRE.ValueMember = "VIGECODI"

                Me.cboREADVIRE.SelectedValue = tbl.Rows(0).Item("READVIRE")

                Dim objdatos57 As New cla_TIPORESO

                Me.cboREADTIRE.DataSource = objdatos57.fun_Consultar_CAMPOS_MANT_TIPORESO
                Me.cboREADTIRE.DisplayMember = "TIREDESC"
                Me.cboREADTIRE.ValueMember = "TIRECODI"

                Me.cboREADTIRE.SelectedValue = tbl.Rows(0).Item("READTIRE")

                Dim objdatos7 As New cla_ESTADO

                Me.cboREADESTA.DataSource = objdatos7.fun_Consultar_TODOS_LOS_ESTADOS
                Me.cboREADESTA.DisplayMember = "ESTADESC"
                Me.cboREADESTA.ValueMember = "ESTACODI"

                Me.cboREADESTA.SelectedValue = tbl.Rows(0).Item("READESTA")
        ...
        Try
            ...
            If boREADCLEN = True And _
               ...
               boREADESTA = True Then
                ...
                If (objdatos22.fun_Actualizar_RESOADMI(inID_REGISTRO, _
                                                       Me.cboREADCLAS.SelectedValue, _
...
#Region "KeyDown"
    ...
    Private Sub cboRECOVIRE_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboREADVIRE.KeyDown
        ...
        End If
    End Sub
    Private Sub cboRECOVIFI_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboREADTIRE.KeyDown
        If e.KeyCode = Keys.Up Or e.KeyCode = Keys.Down Then
            fun_Cargar_ComboBox_Con_Datos_Activos_TIPORESO_Descripcion(Me.cboREADTIRE, Me.cboREADTIRE.SelectedIndex)
        End If
    End Sub
    Private Sub cboRECOESTA_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Up Or e.KeyCode = Keys.Down Then
...
#Region "Click"
    ...
    Private Sub cboRECOVIFI_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboREADTIRE.Click
        fun_Cargar_ComboBox_Con_Datos_Activos_TIPORESO_Descripcion(Me.cboREADTIRE, Me.cboREADTIRE.SelectedIndex)
    End Sub
    Private Sub cboRECOESTA_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        fun_Cargar_ComboBox_Con_Datos_Activos_ESTADO(Me.cboREADESTA, Me.cboREADESTA.SelectedIndex)
    End Sub
