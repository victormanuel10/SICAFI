...
Public Class frm_importar_excel_ESTRFIPR

    '=======================================================
    '*** FORMULARIO IMPORTAR EXCEL ESTRATO FICHA PREDIAL ***
    '=======================================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_importar_excel_ESTRFIPR
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_importar_excel_ESTRFIPR
        End If
...
#Region "VARIABLES"
    ...
    Dim dt_ESFPLIST As New DataTable
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_ValidarEstratoFichaPredial()
        ...
        ' crea la tabla
        dt_ESFPLIST = New DataTable

        ' carga la tabla
        dt_ESFPLIST = Me.dgvFIPRLIST.DataSource

        For i = 0 To dt_ESFPLIST.Rows.Count - 1

            ' verifica que el campo numero de ficha este lleno
            If Trim(dt_ESFPLIST.Rows(i).Item(0).ToString) = "" Then

                dr1 = dt1.NewRow()

                dr1("Nro_Ficha") = Trim(dt_ESFPLIST.Rows(i).Item(0).ToString)
                dr1("Estrato") = Trim(dt_ESFPLIST.Rows(i).Item(1).ToString)
            ...
            ' verifica que el campo estrato este lleno
            If Trim(dt_ESFPLIST.Rows(i).Item(1).ToString) = "" Then

                dr1 = dt1.NewRow()

                dr1("Nro_Ficha") = Trim(dt_ESFPLIST.Rows(i).Item(0).ToString)
                dr1("Estrato") = Trim(dt_ESFPLIST.Rows(i).Item(1).ToString)
                dr1("Descripcion") = "El campo estrato esta vacio"
            ...
            Else
                ...
                tbl = objdatos2.fun_Buscar_CODIGO_MANT_ESTRATO(Trim(dt_ESFPLIST.Rows(i).Item(1).ToString))
                ...
                If tbl.Rows.Count = 0 Then
                    ...
                    dr1("Nro_Ficha") = Trim(dt_ESFPLIST.Rows(i).Item(0).ToString)
                    dr1("Estrato") = Trim(dt_ESFPLIST.Rows(i).Item(1).ToString)
                    dr1("Descripcion") = "Estrato no registrado"
    ...
    Private Sub pro_GuardarEstratoFichaPredial()
        ...
        Try
            ...
            For i = 0 To dt_ESFPLIST.Rows.Count - 1
                ...
                stESFPNUFI = Trim(dt_ESFPLIST.Rows(i).Item(0).ToString)
                stESFPESTR = Trim(dt_ESFPLIST.Rows(i).Item(1).ToString)
                stESFPESTA = "ac"
