...
Public Class frm_importar_excel_FIPRZOEC

    '================================================
    '*** FORMULARIO IMPORTAR EXCEL ZONA ECONOMICA ***
    '================================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_importar_excel_FIPRZOEC
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_importar_excel_FIPRZOEC
        End If
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_Validar()
        ...
        dt1.Columns.Add(New DataColumn("Zona_Economica", GetType(String)))
        ...
        ' carga la tabla
        dt_FIPRZOEC = Me.dgvFIPRLIST.DataSource

        For i = 0 To dt_FIPRZOEC.Rows.Count - 1

            Dim stFPZONUFI As String = Trim(dt_FIPRZOEC.Rows(0).Item(0))
            Dim stFPZOZONA As String = Trim(dt_FIPRZOEC.Rows(0).Item(1))
            Dim stFPZOPORC As String = Trim(dt_FIPRZOEC.Rows(0).Item(2))
            ...
            If Trim(stFPZONUFI) = "" Then
                ...
                dr1("Nro_Ficha") = Trim(dt_FIPRZOEC.Rows(i).Item(0).ToString)
                dr1("Zona_Economica") = Trim(dt_FIPRZOEC.Rows(i).Item(1).ToString)
                dr1("Porcentaje") = Trim(dt_FIPRZOEC.Rows(i).Item(2).ToString)
            ...
            Else
                ...
                Else
                    ...
                    If dtFICHPRED.Rows.Count > 0 Then
                        ...
                        ' instancia la clase
                        Dim obZONAECON As New cla_ZONAECON
                        Dim dtZONAECON As New DataTable

                        dtZONAECON = obZONAECON.fun_Buscar_DEPARTAMENTO_Y_MUNICIPIO_Y_SECTOR_Y_CODIGO_MANT_ZONAECON(stFIPRDEPA, stFIPRMUNI, inFIPRCLSE, stFPZOZONA)

                        If dtZONAECON.Rows.Count = 0 Then
    ...
    Private Sub pro_Guardar()
        ...
        Try
            ...
            ' declara las variables
            Dim inFPZENUFI As Integer = 0
            Dim inFPZEZOEC As Integer = 0
            Dim inFPZEPORC As Integer = 0
            ...
            For i = 0 To dt_FIPRZOEC.Rows.Count - 1
                ...
                inFPZENUFI = Trim(dt_FIPRZOEC.Rows(i).Item(0).ToString)

                Dim boHIAVNUFI As Boolean = fun_Verificar_Dato_Numerico_Evento_Validated(inFPZENUFI)
                ...
                If boHIAVNUFI = True Then
                    ...
                    tbl = objdatos.fun_Consultar_FICHA_PREDIAL_X_NRO_FICHA_PREDIAL(inFPZENUFI)
                    ...
                    If tbl.Rows.Count > 0 Then
                        ...
                        dtFIPRZOEC = obFIPRZOEC.fun_Consultar_FIPRZOEC_X_FICHA_PREDIAL(inFPZENUFI)

                        If dtFIPRZOEC.Rows.Count > 0 Then
                            obFIPRZOEC.fun_Eliminar_FIPRZOEC_X_FICHA_PREDIAL(inFPZENUFI)
                        End If
            ...
            For ii = 0 To dt_FIPRZOEC.Rows.Count - 1

                inFPZENUFI = Trim(dt_FIPRZOEC.Rows(ii).Item(0).ToString)
                inFPZEZOEC = Trim(dt_FIPRZOEC.Rows(ii).Item(1).ToString)
                inFPZEPORC = Trim(dt_FIPRZOEC.Rows(ii).Item(2).ToString)
                ...
                If boHIAVNUFI = True Then
                    ...
                    If tbl.Rows.Count > 0 Then
                        ...
                        ' inserta el registro
                        If obFIPRZOEC.fun_Insertar_FIPRZOEC(inFPZENUFI, inFPZEZOEC, inFPZEPORC, stFIPRDEPA, stFIPRMUNI, inFIPRTIRE, inFIPRCLSE, inFIPRVIGE, inFIPRRESO, inFIPRSECU, inFIPRNURE, stFIPRESTA) = True Then
                            inCantidad += 1
                        End If
