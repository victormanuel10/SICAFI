...
Public Class frm_importar_excel_FIPROBSE

    ' ==========================================
    ' *** IMPORTAR OBSERVACION FICHA PREDIAL ***
    ' ==========================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_importar_excel_FIPROBSE
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_importar_excel_FIPROBSE
        End If
...
#Region "VARIABLES"
    ...
    Dim dt_FIPROBSE As New DataTable
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_ValidarDatos()
        ...
        ' crea la tabla
        dt_FIPROBSE = New DataTable

        ' carga la tabla
        dt_FIPROBSE = Me.dgvFIPRLIST.DataSource

        For i = 0 To dt_FIPROBSE.Rows.Count - 1

            ' verifica el 
            If Trim(dt_FIPROBSE.Rows(i).Item(0).ToString) = "" Then
            ...
            Else
                ...
                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_FIPROBSE.Rows(i).Item(0).ToString)) = False Then
    ...
    Private Sub pro_GuardarDatos()
        ...
        Try
            ...
            Dim inFIPRNUFI As Integer = 0
            Dim stFIPROBSE As String = ""

            For i = 0 To dt_FIPROBSE.Rows.Count - 1

                ' almacena los datos
                inFIPRNUFI = CInt(dt_FIPROBSE.Rows(i).Item(0).ToString)
                stFIPROBSE = CType(Trim(dt_FIPROBSE.Rows(i).Item(1).ToString), String)
                ...
                If dtFICHPRED.Rows.Count > 0 Then
                    ...
                    obFICHPRED.fun_actualizar_OBSERVACION_FICHPRED(inFIPRNUFI, stFIPROBSE)
