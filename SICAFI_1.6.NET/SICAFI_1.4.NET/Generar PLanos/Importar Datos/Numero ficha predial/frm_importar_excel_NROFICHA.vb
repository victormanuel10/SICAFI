...
Public Class frm_importar_excel_NROFICHA

    '===========================================
    '*** FORMULARIO IMPORTAR NUMERO DE FICHA ***
    '===========================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_importar_excel_NROFICHA
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_importar_excel_NROFICHA
        End If
...
#Region "PROCEDIMIENTOS"
    ...
    End Sub
    Private Sub pro_ValidarNroDeFicha()
        ...
        ' Crea las columnas
        dt1.Columns.Add(New DataColumn("Nro_Ficha_Actual", GetType(String)))
        dt1.Columns.Add(New DataColumn("Nro_Ficha_Nuevo", GetType(String)))
        ...
        For i = 0 To dt_ARCOLIST.Rows.Count - 1
            ...
            ' verifica que el campo Nro de ficha actual
            If Trim(dt_ARCOLIST.Rows(i).Item(0).ToString) = "" Then

                dr1 = dt1.NewRow()

                dr1("Nro_Ficha_Actual") = "El campo Nro de ficha actual esta vacio"
                dr1("Nro_Ficha_Nuevo") = Trim(dt_ARCOLIST.Rows(i).Item(1).ToString)
            ...
            Else
                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_ARCOLIST.Rows(i).Item(0).ToString)) = False Then
                    ...
                    dr1("Nro_Ficha_Actual") = "El campo Nro de ficha actual no es numerico"
                    dr1("Nro_Ficha_Nuevo") = Trim(dt_ARCOLIST.Rows(i).Item(1).ToString)
            ...
            ' verifica que el campo Nro de ficha nuevo
            If Trim(dt_ARCOLIST.Rows(i).Item(1).ToString) = "" Then

                dr1 = dt1.NewRow()

                dr1("Nro_Ficha_Actual") = Trim(dt_ARCOLIST.Rows(i).Item(0).ToString)
                dr1("Nro_Ficha_Nuevo") = "El campo Nro de ficha nuevo esta vacio"
            ...
            Else
                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_ARCOLIST.Rows(i).Item(1).ToString)) = False Then
                    ...
                    dr1("Nro_Ficha_Actual") = Trim(dt_ARCOLIST.Rows(i).Item(0).ToString)
                    dr1("Nro_Ficha_Nuevo") = "El campo Nro de ficha actual no es numerico"
    ...
    End Sub
    Private Sub pro_GuardarNroDeFicha()
        ...
        Try
            ...
            Dim inFichaActual As Integer = 0
            Dim inFichaNueva As Integer = 0
            ...
            For i = 0 To dt_ARCOLIST.Rows.Count - 1
                ...
                ' almacena los datos
                inFichaActual = CType(Trim(dt_ARCOLIST.Rows(i).Item(0).ToString), Integer)
                inFichaNueva = CType(Trim(dt_ARCOLIST.Rows(i).Item(1).ToString), Integer)

                Dim objDatos As New cla_FICHPRED
                Dim tblDatos As New DataTable

                tblDatos = objDatos.fun_Consultar_FICHA_PREDIAL_X_NRO_FICHA_PREDIAL(inFichaActual)

                Dim objDatos1 As New cla_FICHPRED
                Dim tblDatos1 As New DataTable

                tblDatos1 = objDatos1.fun_Consultar_FICHA_PREDIAL_X_NRO_FICHA_PREDIAL(inFichaNueva)

                If tblDatos.Rows.Count > 0 And tblDatos1.Rows.Count = 0 Then
                    ...
                    ParametrosConsulta2 += "Set FiprNufi = '" & inFichaNueva & "' "
                    ParametrosConsulta2 += "Where "
                    ParametrosConsulta2 += "FiprNufi = '" & inFichaActual & "' "
                ...
                Else
                    ...
                    dr1("Nro_Ficha_Nuevo") = inFichaNueva
                    dr1("Descripcion") = "Ficha existente en la base de datos"
