...
Public Class frm_importar_excel_COEFEDIF

    '=========================================================
    '*** FORMULARIO IMPORTAR EXCEL COEFICIENTE DE EDIFICIO ***
    '=========================================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_importar_excel_COEFEDIF
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_importar_excel_COEFEDIF
        End If
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_ValidarCategoriaFichaPredial()
        ...
        dt1.Columns.Add(New DataColumn("Coeficiente", GetType(String)))
        ...
        For i = 0 To dt_FPCELIST.Rows.Count - 1
            ...
            If Trim(dt_FPCELIST.Rows(i).Item(0).ToString) = "" Then
                ...
                dr1("Coeficiente") = Trim(dt_FPCELIST.Rows(i).Item(1).ToString)
    ...
    Private Sub pro_GuardarCategoriaFichaPredial()
        ...
        Try
            ...
            For i = 0 To dt_FPCELIST.Rows.Count - 1
                ...
                stFIPRCOED = Trim(dt_FPCELIST.Rows(i).Item(1).ToString)
                stFIPRESTA = "ac"
                ...
                If boFIPRNUFI = True And boFIPRCOED = True Then
                    ...
                    If tbl.Rows.Count > 0 Then
                        ...
                        objdatos1.fun_Actualizar_FICHPRED_X_FIPRCOED(CInt(stFIPRNUFI), CStr(Trim(fun_Formato_Decimal_6_Decimales(stFIPRCOED))))
