...
Public Class frm_importar_excel_CAPRFIPR

    '===================================================================
    '*** FORMULARIO IMPORTAR EXCEL CATEGORIA DE PREDIO FICHA PREDIAL ***
    '===================================================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_importar_excel_CAPRFIPR
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_importar_excel_CAPRFIPR
        End If
...
#Region "VARIABLES"
    ...
    Dim dt_CPFPLIST As New DataTable
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_ValidarCategoriaFichaPredial()
        ...
        dt1.Columns.Add(New DataColumn("Categoria", GetType(String)))
        ...
        ' crea la tabla
        dt_CPFPLIST = New DataTable

        ' carga la tabla
        dt_CPFPLIST = Me.dgvFIPRLIST.DataSource

        For i = 0 To dt_CPFPLIST.Rows.Count - 1

            ' verifica que el campo numero de ficha este lleno
            If Trim(dt_CPFPLIST.Rows(i).Item(0).ToString) = "" Then

                dr1 = dt1.NewRow()

                dr1("Nro_Ficha") = Trim(dt_CPFPLIST.Rows(i).Item(0).ToString)
                dr1("Categoria") = Trim(dt_CPFPLIST.Rows(i).Item(1).ToString)
            ...
            Else
                ...
                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_CPFPLIST.Rows(i).Item(0).ToString)) = False Then
            ...
            If Trim(dt_CPFPLIST.Rows(i).Item(1).ToString) = "" Then

                dr1 = dt1.NewRow()

                dr1("Nro_Ficha") = Trim(dt_CPFPLIST.Rows(i).Item(0).ToString)
                dr1("Categoria") = Trim(dt_CPFPLIST.Rows(i).Item(1).ToString)
                dr1("Descripcion") = "El campo categoria esta vacio"
            ...
            Else
                ...
                tbl = objdatos2.fun_Buscar_CODIGO_MANT_CATEPRED(Trim(dt_CPFPLIST.Rows(i).Item(1).ToString))
                ...
                If tbl.Rows.Count = 0 Then
                    ...
                    dr1("Nro_Ficha") = Trim(dt_CPFPLIST.Rows(i).Item(0).ToString)
                    dr1("Categoria") = Trim(dt_CPFPLIST.Rows(i).Item(1).ToString)
                    dr1("Descripcion") = "Categoria no registrada"
    ...
    Private Sub pro_GuardarCategoriaFichaPredial()
        ...
        Try
            ...
            Dim stCPFPNUFI As String = ""
            Dim stCPFPCAPR As String = ""
            Dim stCPFPESTA As String = ""
            ...
            For i = 0 To dt_CPFPLIST.Rows.Count - 1
                ...
                stCPFPNUFI = Trim(dt_CPFPLIST.Rows(i).Item(0).ToString)
                stCPFPCAPR = Trim(dt_CPFPLIST.Rows(i).Item(1).ToString)
                stCPFPESTA = "ac"

                Dim boCPFPNUFI As Boolean = fun_Verificar_Dato_Numerico_Evento_Validated(stCPFPNUFI)
                Dim boCPFPCAPR As Boolean = fun_Verificar_Dato_Numerico_Evento_Validated(stCPFPCAPR)

                If boCPFPNUFI = True And boCPFPCAPR = True Then

                    ' Instancia la clase
                    Dim objdatos As New cla_CAPRFIPR
                    Dim tbl As New DataTable

                    tbl = objdatos.fun_Buscar_CATEGORIA_X_NRO_DE_FICHA_Y_CATEGORIA(stCPFPNUFI, stCPFPCAPR)

                    If tbl.Rows.Count > 0 Then

                        Dim objdatos1 As New cla_CAPRFIPR
                        objdatos1.fun_Actualizar_CAPRFIPR(stCPFPNUFI, stCPFPCAPR, stCPFPESTA)
                    Else
                        Dim objdatos1 As New cla_CAPRFIPR
                        objdatos1.fun_Insertar_CAPRFIPR(stCPFPNUFI, stCPFPCAPR, stCPFPESTA)
