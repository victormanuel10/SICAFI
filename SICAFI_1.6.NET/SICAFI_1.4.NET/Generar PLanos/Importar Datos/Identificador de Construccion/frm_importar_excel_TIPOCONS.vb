...
Public Class frm_importar_excel_TIPOCONS

    '===============================================================
    '*** FORMULARIO IMPORTAR EXCEL IDENTIFICADOR DE CONSTRUCCIÓN ***
    '===============================================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_importar_excel_TIPOCONS
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_importar_excel_TIPOCONS
        End If
...
#Region "VARIABLES"
    ...
    Dim dt_IDENTIFICADOR As New DataTable
...
#Region "PROCEDIMIENTOS"
    ...
    End Sub
    Private Sub pro_ValidarEstratoFichaPredial()
        ...
        ' Crea las columnas
        dt1.Columns.Add(New DataColumn("Departamento", GetType(String)))
        dt1.Columns.Add(New DataColumn("Municipio", GetType(String)))
        dt1.Columns.Add(New DataColumn("Sector", GetType(String)))
        dt1.Columns.Add(New DataColumn("Clase", GetType(String)))
        ...
        dt1.Columns.Add(New DataColumn("PuntajeP", GetType(String)))
        dt1.Columns.Add(New DataColumn("PuntajeM", GetType(String)))
        ...
        ' crea la tabla
        dt_IDENTIFICADOR = New DataTable

        ' carga la tabla
        dt_IDENTIFICADOR = Me.dgvFIPRLIST.DataSource

        For i = 0 To dt_IDENTIFICADOR.Rows.Count - 1

            ' verifica departamento
            If Trim(dt_IDENTIFICADOR.Rows(i).Item(0).ToString) = "" Then

                dr1 = dt1.NewRow()

                dr1("Departamento") = Trim(dt_IDENTIFICADOR.Rows(i).Item(0).ToString)
                dr1("Municipio") = Trim(dt_IDENTIFICADOR.Rows(i).Item(1).ToString)
                dr1("Sector") = Trim(dt_IDENTIFICADOR.Rows(i).Item(2).ToString)
                dr1("Clase") = Trim(dt_IDENTIFICADOR.Rows(i).Item(3).ToString)
                dr1("Tipo") = Trim(dt_IDENTIFICADOR.Rows(i).Item(4).ToString)
                dr1("Identificador") = Trim(dt_IDENTIFICADOR.Rows(i).Item(5).ToString)
                dr1("Descripcion") = Trim(dt_IDENTIFICADOR.Rows(i).Item(6).ToString)
                dr1("PuntajeP") = Trim(dt_IDENTIFICADOR.Rows(i).Item(7).ToString)
                dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                dr1("Descripcion") = "El campo departamento esta vacio"

                dt1.Rows.Add(dr1)

            Else

                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_IDENTIFICADOR.Rows(i).Item(0).ToString)) = False Then
                    ...
                    dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                    dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                    dr1("Descripcion") = "El campo departamento no es numerico"
                ...
                Else
                    ...
                    tbl = objdatos2.fun_Buscar_CODIGO_MANT_DEPARTAMENTO(fun_Formato_Mascara_2_String(Trim(dt_IDENTIFICADOR.Rows(i).Item(0).ToString)))
                    ...
                    If tbl.Rows.Count = 0 Then
                        ...
                        dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                        dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                        dr1("Descripcion") = "Departamento no registrado"
            ...
            ' verifica Municipio
            If Trim(dt_IDENTIFICADOR.Rows(i).Item(1).ToString) = "" Then
                ...
                dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                dr1("Descripcion") = "El campo Municipio esta vacio"

                dt1.Rows.Add(dr1)

            Else

                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_IDENTIFICADOR.Rows(i).Item(1).ToString)) = False Then
                    ...
                    dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                    dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                    dr1("Descripcion") = "El campo Municipio no es numerico"
                ...
                Else
                    ...
                    tbl = objdatos2.fun_Buscar_DEPARTAMENTO_Y_CODIGO_MANT_MUNICIPIO(fun_Formato_Mascara_2_String(Trim(dt_IDENTIFICADOR.Rows(i).Item(0).ToString)), fun_Formato_Mascara_3_String(Trim(dt_IDENTIFICADOR.Rows(i).Item(1).ToString)))
                    ...
                    If tbl.Rows.Count = 0 Then
                        ...
                        dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                        dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                        dr1("Descripcion") = "Municipio no registrado"
            ...
            ' verifica Sector
            If Trim(dt_IDENTIFICADOR.Rows(i).Item(2).ToString) = "" Then
                ...
                dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                dr1("Descripcion") = "El campo Sector esta vacio"

                dt1.Rows.Add(dr1)

            Else

                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_IDENTIFICADOR.Rows(i).Item(2).ToString)) = False Then
                    ...
                    dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                    dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                    dr1("Descripcion") = "El campo Sector no es numerico"
                ...
                Else
                    ...
                    tbl = objdatos2.fun_Buscar_CODIGO_MANT_CLASSECT(Trim(dt_IDENTIFICADOR.Rows(i).Item(2).ToString))
                    ...
                    If tbl.Rows.Count = 0 Then
                        ...
                        dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                        dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                        dr1("Descripcion") = "Sector no registrado"
            ...
            ' verifica Clase de construcción
            If Trim(dt_IDENTIFICADOR.Rows(i).Item(3).ToString) = "" Then
                ...
                dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                dr1("Descripcion") = "El campo Clase esta vacio"

                dt1.Rows.Add(dr1)

            Else

                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_IDENTIFICADOR.Rows(i).Item(3).ToString)) = False Then
                    ...
                    dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                    dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                    dr1("Descripcion") = "El campo Clase no es numerico"
                ...
                Else
                    ...
                    tbl = objdatos2.fun_Buscar_CODIGO_MANT_CLASCONS(Trim(dt_IDENTIFICADOR.Rows(i).Item(3).ToString))
                    ...
                    If tbl.Rows.Count = 0 Then
                        ...
                        dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                        dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                        dr1("Descripcion") = "Clase no registrado"
            ...
            ' verifica Tipo
            If Trim(dt_IDENTIFICADOR.Rows(i).Item(4).ToString) = "" Then
                ...
                dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                dr1("Descripcion") = "El campo Tipo esta vacio"

                dt1.Rows.Add(dr1)

            Else

                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_IDENTIFICADOR.Rows(i).Item(4).ToString)) = True Then
                    ...
                    dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                    dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                    dr1("Descripcion") = "El campo Tipo es numerico"
                ...
                Else
                    ...
                    tbl = objdatos2.fun_Buscar_CODIGO_MANT_TIPOCALI(Trim(dt_IDENTIFICADOR.Rows(i).Item(4).ToString))
                    ...
                    If tbl.Rows.Count = 0 Then
                        ...
                        dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                        dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                        dr1("Descripcion") = "Tipo no registrado"
            ...
            If Trim(dt_IDENTIFICADOR.Rows(i).Item(5).ToString) = "" Then
                ...
                dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                dr1("Descripcion") = "El campo Identificador esta vacio"
            ...
            If Trim(dt_IDENTIFICADOR.Rows(i).Item(6).ToString) = "" Then
                ...
                dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                dr1("Descripcion") = "El campo Descripcion esta vacio"

                dt1.Rows.Add(dr1)

            End If

            ' verifica Puntaje Predeterminado
            If Trim(dt_IDENTIFICADOR.Rows(i).Item(7).ToString) = "" Then
                ...
                dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                dr1("Descripcion") = "El campo Puntaje Predeterminado esta vacio "

                dt1.Rows.Add(dr1)

            Else

                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_IDENTIFICADOR.Rows(i).Item(7).ToString)) = False Then
                    ...
                    dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                    dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                    dr1("Descripcion") = "El campo Puntaje Predeterminado no es numerico"
            ...
            ' verifica Puntaje maximo
            If Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString) = "" Then
                ...
                dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                dr1("Descripcion") = "El campo Puntaje Maximo esta vacio "

                dt1.Rows.Add(dr1)

            Else

                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)) = False Then
                    ...
                    dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                    dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                    dr1("Descripcion") = "El campo Puntaje Maximo no es numerico "
            ...
            ' verifica Estado
            If Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString) = "" Then
                ...
                dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                dr1("Descripcion") = "El campo Estado esta vacio"

                dt1.Rows.Add(dr1)

            Else

                If fun_Verificar_Dato_Numerico_Evento_Validated(Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)) = True Then
                    ...
                    dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                    dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                    dr1("Descripcion") = "El campo Estado es numerico"
                ...
                Else
                    ...
                    tbl = objdatos2.fun_Buscar_CODIGO_ESTADO(Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString))
                    ...
                    If tbl.Rows.Count = 0 Then
                        ...
                        dr1("PuntajeM") = Trim(dt_IDENTIFICADOR.Rows(i).Item(8).ToString)
                        dr1("Estado") = Trim(dt_IDENTIFICADOR.Rows(i).Item(9).ToString)
                        dr1("Descripcion") = "Estado no registrado"
    ...
    End Sub
    Private Sub pro_GuardarEstratoFichaPredial()
        ...
        Try
            ...
            Dim stESFPNUFI As String = ""
            Dim stESFPESTR As String = ""
            Dim stESFPESTA As String = ""
            ...
            For i = 0 To dt_IDENTIFICADOR.Rows.Count - 1
                ...
                stESFPNUFI = Trim(dt_IDENTIFICADOR.Rows(i).Item(0).ToString)
                stESFPESTR = Trim(dt_IDENTIFICADOR.Rows(i).Item(1).ToString)
                stESFPESTA = "ac"

                Dim boESFPNUFI As Boolean = fun_Verificar_Dato_Numerico_Evento_Validated(stESFPNUFI)
                Dim boESFPESTR As Boolean = fun_Verificar_Dato_Numerico_Evento_Validated(stESFPESTR)

                If boESFPNUFI = True And boESFPESTR = True Then

                    ' Instancia la clase
                    Dim objdatos As New cla_ESTRFIPR
                    Dim tbl As New DataTable

                    tbl = objdatos.fun_Buscar_CODIGO_ESTRFIPR(stESFPNUFI, stESFPESTR)

                    If tbl.Rows.Count > 0 Then

                        Dim objdatos1 As New cla_ESTRFIPR
                        objdatos1.fun_Actualizar_ESTRFIPR(stESFPNUFI, stESFPESTR, stESFPESTA)
                    Else

                        Dim objdatos2 As New cla_ESTRFIPR
                        objdatos2.fun_Insertar_ESTRFIPR(stESFPNUFI, stESFPESTR, stESFPESTA)
    ...
    Private Sub cmdValidaDatos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdValidaDatos.Click
        Try
            ...
            If Trim(stRutaArchivo) <> "" And Me.dgvFIPRLIST.RowCount > 0 Then
                ...
                pro_ValidarEstratoFichaPredial()
        ...
        Try
            If Me.dgvFIPRINCO.RowCount = 0 Then
                If Trim(stRutaArchivo) <> "" Then
                    ...
                    pro_GuardarEstratoFichaPredial()
