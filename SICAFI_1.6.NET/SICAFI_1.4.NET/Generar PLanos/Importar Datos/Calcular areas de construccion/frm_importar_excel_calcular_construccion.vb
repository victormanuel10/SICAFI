...
Public Class frm_importar_excel_calcular_construccion

    '=================================================================
    '*** FORMULARIO IMPORTAR EXCEL CALCULO DE AREA DE CONSTRUCCION ***
    '=================================================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_importar_excel_calcular_construccion
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_importar_excel_calcular_construccion
        End If
...
#Region "VARIABLES"
    ...
    Private vl_inCantidadActualizada As Integer = 0
...
#Region "FUNCIONES"
    ...
    End Function
    Private Function fun_SumatoriaTotalAreaConstruccion(ByVal inFIPRNUFI) As Double
        ...
        Try
            ...
            If dtFIPRCONS.Rows.Count > 1 Then
                ...
                For i = 0 To dtFIPRCONS.Rows.Count - 1
                    ...
                    doTotalAreaConstruccion += CDbl(dtFIPRCONS.Rows(i).Item("FPCOARCO").ToString)
    ...
    End Function
    Private Function fun_ActualizaAreaConstruccionUnidadUno(ByVal inFIPRNUFI As Integer, ByVal doFPCOARCO As Double) As Boolean
        ...
        Try
            ...
            ParametrosConsulta += "set FPCOARCO = '" & CStr(fun_Formato_Decimal_2_Decimales(doFPCOARCO).ToString) & "' "
            ...
            vl_inCantidadActualizada += oReader.RecordsAffected
...
#Region "PROCEDIMIENTOS"
    ...
    End Sub
    Private Sub pro_ValidarCalculoDeAreasDeConstruccion()
    ...
    End Sub
    Private Sub pro_GuardarAreaConstruccionCalculada()
        ...
        Try
            ...
            For i = 0 To dt_ARTELIST.Rows.Count - 1
                ...
                If dt1.Rows.Count > 0 Then
                    ...
                    If CInt(dt1.Rows(0).Item("FiprCapr")) = 1 Or _
                       CInt(dt1.Rows(0).Item("FiprCapr")) = 6 Or _
                       CInt(dt1.Rows(0).Item("FiprCapr")) = 7 Then
                        ...
                        If fun_VerificaLaCantidadNroDeConstrucciones(inNroFicha) = True And _
                            fun_VerificaLaClaseDeConstruccion(inNroFicha) = True Then

                            ' declaro la variable
                            Dim doTotalAreaConstruccion As Double = fun_SumatoriaTotalAreaConstruccion(inNroFicha)
                            Dim doTotalAreaConstruccionMayorUnidadUno As Double = fun_SumatoriaDeAreasConsMayorUnidadUno(inNroFicha)
                            Dim doAreaConstruccionUnidadUno As Double = doTotalAreaConstruccion - doTotalAreaConstruccionMayorUnidadUno

                            ' actualiza area unidad uno
                            fun_ActualizaAreaConstruccionUnidadUno(inNroFicha, doAreaConstruccionUnidadUno)
            ...
            ' comando grabar datos
            MessageBox.Show("Proceso de actualizar terminado correctamente." & " Cantidad: " & vl_inCantidadActualizada, "Mensaje ...", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
        ...
        Try
            ...
            If Trim(stRutaArchivo) <> "" And Me.dgvFIPRLIST.RowCount > 0 Then
                ...
                If Me.rbdImportarCedulaCatastral.Checked = True Then
                    pro_ValidarCalculoDeAreasDeConstruccion()
        ...
        Try
            If Me.dgvFIPRINCO.RowCount = 0 Then
                If Trim(stRutaArchivo) <> "" Then
                    ...
                    If Me.rbdImportarCedulaCatastral.Checked = True Then
                        pro_GuardarAreaConstruccionCalculada()
