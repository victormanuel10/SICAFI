...
Public Class frm_insertar_MUTAMARE

    '==============================================
    '*** INSERTAR MUTACION MATERIAL DE REGISTRO ***
    '==============================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            ...
            Dim objdatos9 As New cla_MUTAMARE
            Dim tbl9 As New DataTable

            tbl9 = objdatos9.fun_Buscar_ID_X_CONSULTA_PARAMETRIZADA_MUTAMARE(inID_REGISTRO)

            If tbl9.Rows.Count > 0 Then

                Me.txtMUMRFECH.Text = Trim(tbl9.Rows(0).Item("MUMRFECH"))
                Me.txtMUMROBSE.Text = Trim(tbl9.Rows(0).Item("MUMROBSE").ToString)
                ...
                For i = 0 To tbl9.Rows.Count - 1
                    ...
                    dr1("Código") = Trim(tbl9.Rows(i).Item("MUMRMACA").ToString)
                ...
                Me.dgvMATEREGI.Columns("Código").Width = 25
                Me.dgvMATEREGI.Columns("Descripción").Width = 250

            Else

                Me.txtMUMRFECH.Text = fun_fecha()
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            If Me.dgvMATEREGI.RowCount = 0 Then
                Dim objdatos15 As New cla_MUTAMARE
                objdatos15.fun_Eliminar_SECU_MUTAMARE(inID_REGISTRO)

                mod_MENSAJE.Se_Guardaron_Los_Datos_Correctamente()
                Me.Close()
            Else
                ' elimina los registros
                Dim objdatos11 As New cla_MUTAMARE
                objdatos11.fun_Eliminar_SECU_MUTAMARE(inID_REGISTRO)
                ...
                For i = 0 To tbl.Rows.Count - 1
                    ...
                    Dim objdatos12 As New cla_MUTAMARE
                    objdatos12.fun_Insertar_MUTAMARE(inID_REGISTRO, stCODIGO, Me.txtMUMRFECH.Text, Me.txtMUMROBSE.Text)
    ...
    Private Sub cmdAGREGAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAGREGAR.Click
        ...
        Try
            If Me.dgvMATECAMP.SelectedRows.Count > 0 Then
                ...
                If bySW = 1 Then
                    MessageBox.Show("Código existente en material de registro", "Mensaje ...", MessageBoxButtons.OK, MessageBoxIcon.Hand, MessageBoxDefaultButton.Button1)
                Else
                    dr1 = dt1.NewRow()
    ...
    Private Sub cmdELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdELIMINAR.Click
        ...
        Try
            ...
            Else
                MessageBox.Show("Seleccione un código del material de registro", "Mensaje ...", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
            End If
...
#Region "KeyPress"
    ...
    Private Sub txt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtMUMROBSE.KeyPress
...
#Region "GotFocus"
    ...
    Private Sub txt_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMUMROBSE.GotFocus, txtMUMRFECH.GotFocus
