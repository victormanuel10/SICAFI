...
Public Class frm_insertar_archivo_MUTAPRIM

    '====================================================
    '*** INSERTAR ARCHIVO MUTACIONES DE PRIMERA CLASE ***
    '====================================================
...
#Region "VARIABLE"
    ...
    Dim lv_inOBURRESO As Integer = 0
...
#Region "CONSTRUCTOR"
    ...
    Public Sub New(ByVal inOBURVIGE As Integer, _
                   ByVal inOBURRESO As Integer)

        lv_inOBURVIGE = inOBURVIGE
        lv_inOBURRESO = inOBURRESO
    ...
    Private Function fun_consultarRutaDestino() As String
        ...
        Try
            ...
            If tblRutas.Rows.Count > 0 Then
                ...
                ' directorio pricipal
                stRuta = Trim(tblRutas.Rows(0).Item("RUTARUTA")) & "\" & Trim(lv_inOBURVIGE) & "-" & lv_inOBURRESO & "\" & Me.lstLISTADO_DOCUMENTOS.SelectedItem
