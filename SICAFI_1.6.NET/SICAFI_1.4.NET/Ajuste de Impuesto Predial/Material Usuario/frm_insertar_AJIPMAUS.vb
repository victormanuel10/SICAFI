...
Public Class frm_insertar_AJIPMAUS

    '===================================================
    '*** INSERTAR MATERIAL DE USUARIO AJUSTE PREDIAL ***
    '===================================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            ...
            Dim objdatos9 As New cla_AJIPMAUS
            Dim tbl9 As New DataTable

            tbl9 = objdatos9.fun_Buscar_ID_X_CONSULTA_PARAMETRIZADA_AJIPMAUS(inID_REGISTRO)

            If tbl9.Rows.Count > 0 Then

                Me.txtMAUSFECH.Text = Trim(tbl9.Rows(0).Item("AJMUFECH"))
                Me.txtMAUSOBSE.Text = Trim(tbl9.Rows(0).Item("AJMUOBSE").ToString)
                ...
                For i = 0 To tbl9.Rows.Count - 1
                    ...
                    dr1("Código") = Trim(tbl9.Rows(i).Item("AJMUMACA").ToString)
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            If Me.dgvMATEUSUA.RowCount = 0 Then
                Dim objdatos15 As New cla_AJIPMAUS
                objdatos15.fun_Eliminar_SECU_AJIPMAUS(inID_REGISTRO)
            ...
            Else
                ...
                Dim objdatos11 As New cla_AJIPMAUS
                objdatos11.fun_Eliminar_SECU_AJIPMAUS(inID_REGISTRO)
                ...
                For i = 0 To tbl.Rows.Count - 1
                    ...
                    Dim objdatos12 As New cla_AJIPMAUS
                    objdatos12.fun_Insertar_AJIPMAUS(inID_REGISTRO, stCODIGO, Me.txtMAUSFECH.Text, Me.txtMAUSOBSE.Text)
