...
Public Class frm_insertar_FIPRCACO
                    ...
                    Else
                        ...
                        If inCODIGO_SUBBLOQUE = 11 Or _
                            ...
                            If dt.Rows.Count > 0 Then
                                txtFPCCCODI.Focus()
                                ErrorProvider1.SetError(Me.txtFPCCCODI, "Código de calificación existente en el sub bloque")
                                strBARRESTA.Items(1).Text = "Código de calificación existente en el sub bloque"
                                txtFPCCCODI.SelectionStart = 0
                                txtFPCCCODI.SelectionLength = Len(txtFPCCCODI.Text)
                            Else
