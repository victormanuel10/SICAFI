...
Public Class frm_consultar_RESOLUCION_FICHPRED
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_Reconsultar()
        Try
            ...
            BindingSource_RESOLUCION_1.DataSource = objdatos.fun_Consultar_RESOLUCION_X_ESTADO
            dgvRESOLUCION.DataSource = BindingSource_RESOLUCION_1
            BindingNavigator_RESOLUCION_1.BindingSource = BindingSource_RESOLUCION_1

            strBARRESTA.Items(2).Text = "Registros : " & BindingSource_RESOLUCION_1.Count

            'Oculta la columna del DataGridView
            dgvRESOLUCION.Columns(0).Visible = False
            dgvRESOLUCION.Columns(7).Visible = False
            dgvRESOLUCION.Columns(8).Visible = False
            dgvRESOLUCION.Columns(9).Visible = False
            dgvRESOLUCION.Columns(10).Visible = False
            dgvRESOLUCION.Columns(11).Visible = False
            dgvRESOLUCION.Columns(12).Visible = False
            'dgvRESOLUCION.Columns(13).Visible = False
            dgvRESOLUCION.Columns(14).Visible = False
...
#Region "MENU"
    ...
    Private Sub cmdACEPTAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdACEPTAR.Click
        Try
            Dim frm_FICHPRED As New frm_FICHPRED(Integer.Parse(dgvRESOLUCION.CurrentRow.Cells(0).Value.ToString()))
            Me.Close()
