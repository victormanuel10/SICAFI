...
Public Class frm_modificar_PROPANTE

    '======================================
    '*** MODIFICAR PROPIETARIO ANTERIOR ***
    '======================================

#Region "VARIABLE"

    Dim vl_inFIPRIDRE As Integer
...
#Region "CONSTRUCTOR"
    ...
    End Sub
    Public Sub New(ByVal inFIPRNUFI As Integer, ByVal stFPPRNUDO As String, ByVal inFIPRIDRE As Integer)
        vl_inFIPRNUFI = inFIPRNUFI
        vl_stFPPRNUDO = stFPPRNUDO
        vl_inFIPRIDRE = inFIPRIDRE
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            ...
            Dim objdatos124 As New cla_PROPANTE
            Dim tbl124 As New DataTable

            tbl124 = objdatos124.fun_Buscar_PROPIETARIOS_X_NRO_DE_FICHA_Y_NRO_DE_DOCUMENTO(vl_inFIPRNUFI, Trim(vl_stFPPRNUDO))

            If tbl124.Rows.Count > 0 Then
                ...
                Me.cboPRANCAAC.SelectedValue = tbl124.Rows(0).Item("PRANCAAC")
                Me.txtPRANPRAP.Text = Trim(tbl124.Rows(0).Item("PRANPRAP"))
                Me.txtPRANSEAP.Text = Trim(tbl124.Rows(0).Item("PRANSEAP"))
                Me.txtPRANNOMB.Text = Trim(tbl124.Rows(0).Item("PRANNOMB"))
                Me.txtPRANOBSE.Text = Trim(tbl124.Rows(0).Item("PRANOBSE"))
                Me.cboPRANESTA.SelectedValue = tbl124.Rows(0).Item("PRANESTA")

            End If

            Dim boPRANCAAC As Boolean = fun_Buscar_Dato_CAUSACTO(Trim(Me.cboPRANCAAC.SelectedValue))

            If boPRANCAAC = True Then

                Me.lblPRANCAAC.Text = fun_Buscar_Lista_Valores_CAUSACTO(Trim(Me.cboPRANCAAC.SelectedValue))
        ...
        Try
            ...
            If boPRANPRAN = True And _
               ...
               boPRANCAAC = True Then
                ...
                If (objdatos22.fun_Actualizar_PROPANTE(vl_inFIPRNUFI, _
                                                       vl_stFPPRNUDO, _
