...
Public Class frm_insertar_REAVMAFA

    '=============================================
    '*** MATERIAL FALTANTE REVISION DE AVALUOS ***
    '=============================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            ...
            Dim objdatos9 As New cla_REAVMAFA
            Dim tbl9 As New DataTable

            tbl9 = objdatos9.fun_Buscar_ID_X_CONSULTA_PARAMETRIZADA_REAVMAFA(inID_REGISTRO)

            If tbl9.Rows.Count > 0 Then

                Me.txtRAMFFECH.Text = Trim(tbl9.Rows(0).Item("RAMFFECH"))
                'Me.txtRAMFOBSE.Text = Trim(tbl9.Rows(0).Item("RAMFOBSE").ToString)

                If fun_Verificar_Dato_Fecha_Evento_Validated(Me.txtRAMFFECH.Text) = True Then
                    Me.DateTimePicker1.Value = CDate(tbl9.Rows(0).Item("RAMFFECH"))
                End If
                ...
                For i = 0 To tbl9.Rows.Count - 1
                    ...
                    dr1("Código") = Trim(tbl9.Rows(i).Item("RAMFMACA").ToString)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim obRECLOBME As New cla_REAVOBMF
            Dim dtRECLOBME As New DataTable

            dtRECLOBME = obRECLOBME.fun_Buscar_CODIGO_X_REAVOBMF(inID_REGISTRO)

            If dtRECLOBME.Rows.Count = 0 Then
                obRECLOBME.fun_Insertar_REAVOBMF(inID_REGISTRO, " Nota ingresada por: " & vp_usuario & " " & fun_fecha() & " : " & Trim(Me.txtRAMFOBSE.Text) & ". ")
            Else

                Dim stMAUSOBSE_NUEVA As String = Trim(Me.txtRAMFOBSE.Text)
                ...
                obRECLOBME.fun_Actualizar_REAVOBMF(inID_REGISTRO, Trim(stMAUSOBSE_ANTERIOR))
            End If

            If Me.dgvMATEFALT.RowCount = 0 Then
                Dim objdatos15 As New cla_REAVMAFA
                objdatos15.fun_Eliminar_SECU_REAVMAFA(inID_REGISTRO)
            ...
            Else
                ...
                Dim objdatos11 As New cla_REAVMAFA
                objdatos11.fun_Eliminar_SECU_REAVMAFA(inID_REGISTRO)

                Dim tbl As New DataTable
                tbl = Me.dgvMATEFALT.DataSource

                Dim obj_REAVMAEN As New cla_REAVMAEN
                Dim dt_REAVMAEN As New DataTable

                dt_REAVMAEN = obj_REAVMAEN.fun_Buscar_ID_X_CONSULTA_PARAMETRIZADA_REAVMAEN(inID_REGISTRO)
                ...
                For i = 0 To tbl.Rows.Count - 1
                    ...
                    While j1 < dt_REAVMAEN.Rows.Count And sw1 = 0
                        If tbl.Rows(i).Item("Código") = dt_REAVMAEN.Rows(j1).Item("RAMEMACA") Then
                            sw1 = 1

                            Dim objEliminaMaterialFaltante As New cla_REAVMAEN
                            objEliminaMaterialFaltante.fun_Eliminar_SECU_X_MACA_REAVMAEN(inID_REGISTRO, dt_REAVMAEN.Rows(j1).Item("RAMEMACA"))
                        Else
                            j1 = j1 + 1
                        End If
                    End While

                    Dim objdatos12 As New cla_REAVMAFA
                    objdatos12.fun_Insertar_REAVMAFA(inID_REGISTRO, stCODIGO, Me.txtRAMFFECH.Text, Me.txtRAMFOBSE.Text)
...
#Region "KeyPress"
    ...
    Private Sub txt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtRAMFOBSE.KeyPress
...
#Region "GotFocus"
    ...
    Private Sub txt_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtRAMFOBSE.GotFocus, txtRAMFFECH.GotFocus
...
#Region "ValueChanged"
    ...
    Private Sub DateTimePicker1_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DateTimePicker1.ValueChanged
        Me.txtRAMFFECH.Text = Me.DateTimePicker1.Value
    End Sub
