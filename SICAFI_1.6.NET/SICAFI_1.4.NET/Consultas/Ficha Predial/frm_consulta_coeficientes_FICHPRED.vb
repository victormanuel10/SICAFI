...
Public Class frm_consulta_coeficientes_FICHPRED
...
#Region "VARIABLES LOCALES"
    ...
    Dim stCONDCOPR As String
    Dim stCONDCOED As String
    ...
    Dim Guardar_stCONDCOPR As String
    Dim Guardar_stCONDCOED As String
    Dim Guardar_stFIPRCOPR As String
    Dim Guardar_stFIPRCOED As String
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        txtFIPRARTE.Text = ""
        txtFIPRESTA.Text = ""
        lblTOTAARTE_MTS.Text = "0"
        lblTOTAARTE_HEC.Text = "0.0000"
        txtRUTA.Text = ""
        cboCONDCOPR.SelectedIndex = 0
        cboCONDCOED.SelectedIndex = 0
        txtRESOMUNI.Text = ""
        txtRESORESO.Text = ""
        txtRESOTIRE.Text = ""
        txtRESOVIGE.Text = ""
        ...
        txtFIPRCOPR.Text = ""
        txtFIPRCOED.Text = ""
        lblTOTACOPR.Text = "0.000000"
        lblTOTACOED.Text = "0.000000"
    ...
    Private Sub pro_VerificarDatos()
        ...
        stCONDCOPR = txtCONDCOPR.Text
        stCONDCOED = txtCONDCOED.Text
        ...
        If Trim(txtFIPRCOPR.Text) = "" And Trim(txtCONDCOPR.Text) = "like" Then
            stFIPRCOPR = "%"
        End If
        ...
        If Trim(txtFIPRCOED.Text) = "" And Trim(txtFIPRCOED.Text) = "like" Then
            stFIPRCOED = "%"
        End If
        ...
        Try
            ...
            While I < dgvCONSULTA.RowCount And SW = 0
                If dgvCONSULTA.CurrentRow.Cells(I).Selected Then
                    ...
                    txtFIPRCOPR.Text = Trim(dgvCONSULTA.CurrentRow.Cells(1).Value.ToString())
                    txtFIPRCOED.Text = Trim(dgvCONSULTA.CurrentRow.Cells(2).Value.ToString())
                    txtFIPRARTE.Text = Trim(dgvCONSULTA.CurrentRow.Cells(3).Value.ToString())
                    txtFIPRMUNI.Text = Trim(dgvCONSULTA.CurrentRow.Cells(4).Value.ToString())
                    txtFIPRCORR.Text = Trim(dgvCONSULTA.CurrentRow.Cells(5).Value.ToString())
                    txtFIPRBARR.Text = Trim(dgvCONSULTA.CurrentRow.Cells(6).Value.ToString())
                    txtFIPRMANZ.Text = Trim(dgvCONSULTA.CurrentRow.Cells(7).Value.ToString())
                    txtFIPRPRED.Text = Trim(dgvCONSULTA.CurrentRow.Cells(8).Value.ToString())
                    txtFIPREDIF.Text = Trim(dgvCONSULTA.CurrentRow.Cells(9).Value.ToString())
                    txtFIPRUNPR.Text = Trim(dgvCONSULTA.CurrentRow.Cells(10).Value.ToString())
                    txtFIPRCLSE.Text = Trim(dgvCONSULTA.CurrentRow.Cells(11).Value.ToString())
                    txtFIPRCASU.Text = Trim(dgvCONSULTA.CurrentRow.Cells(12).Value.ToString())
                    txtFIPRCAPR.Text = Trim(dgvCONSULTA.CurrentRow.Cells(13).Value.ToString())
                    txtFIPRMOAD.Text = Trim(dgvCONSULTA.CurrentRow.Cells(14).Value.ToString())
                    txtFIPRESTA.Text = Trim(dgvCONSULTA.CurrentRow.Cells(15).Value.ToString())
                    txtRESOMUNI.Text = Trim(dgvCONSULTA.CurrentRow.Cells(4).Value.ToString())
                    txtRESOTIRE.Text = Trim(dgvCONSULTA.CurrentRow.Cells(16).Value.ToString())
                    txtRESOVIGE.Text = Trim(dgvCONSULTA.CurrentRow.Cells(17).Value.ToString())
                    txtRESORESO.Text = Trim(dgvCONSULTA.CurrentRow.Cells(18).Value.ToString())
                    txtFIPRDIRE.Text = Trim(dgvCONSULTA.CurrentRow.Cells(20).Value.ToString())
    ...
    Private Sub pro_GuardarConsulta()
        ...
        Guardar_stCONDCOPR = Trim(txtCONDCOPR.Text)
        Guardar_stCONDCOED = Trim(txtCONDCOED.Text)
        Guardar_stFIPRCOPR = Trim(txtFIPRCOPR.Text)
        Guardar_stFIPRCOED = Trim(txtFIPRCOED.Text)
        ...
        Guardar_stFIPRARTE = Trim(txtFIPRARTE.Text)
        Guardar_stFIPRESTA = Trim(txtFIPRESTA.Text)

    End Sub
    Private Sub pro_ObtenerConsulta()

        txtCONDCOPR.Text = Guardar_stCONDCOPR
        cboCONDCOPR.Text = Guardar_stCONDCOPR
        txtCONDCOED.Text = Guardar_stCONDCOED
        cboCONDCOED.Text = Guardar_stCONDCOED
        txtFIPRCOPR.Text = Guardar_stFIPRCOPR
        txtFIPRCOED.Text = Guardar_stFIPRCOED
        ...
        txtFIPRARTE.Text = Guardar_stFIPRARTE
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_consulta_coeficientes_FICHPRED
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_consulta_coeficientes_FICHPRED
        End If
...
#Region "MENU"
    ...
    Private Sub cmdCONSULTAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCONSULTAR.Click
        ...
        Try
            ...
            ParametrosConsulta += "FiprCopr as CoePredio, "
            ParametrosConsulta += "FiprCoed as CoeEdificio, "
            ...
            ParametrosConsulta += "FiprCopr " & stCONDCOPR & " "
            ParametrosConsulta += "'" & stFIPRCOPR & "' and "
            ParametrosConsulta += "FiprCoed " & stCONDCOED & " "
            ParametrosConsulta += "'" & stFIPRCOED & "' and "
            ...
            If dt.Rows.Count > 0 Then
                ...
                Dim i As Integer
                Dim loTotalAreaTerreno As Long

                ' suma el area de terreno
                For i = 0 To dt.Rows.Count - 1
                    loTotalAreaTerreno += Integer.Parse(dgvCONSULTA.Item(3, i).Value.ToString)
                Next

                Dim h As Integer
                Dim doTotalCoePredio As Double

                ' suma el coeficiente de predio
                For h = 0 To dt.Rows.Count - 1
                    doTotalCoePredio += Double.Parse(dgvCONSULTA.Item(1, h).Value.ToString)
                Next

                Dim j As Integer
                Dim doTotalCoeEdificio As Double

                ' suma el coeficiente de edificio
                For j = 0 To dt.Rows.Count - 1
                    doTotalCoeEdificio += Double.Parse(dgvCONSULTA.Item(2, j).Value.ToString)
                Next

                ' llena los totales
                lblTOTACOPR.Text = CType(fun_Formato_Decimal_6_Decimales(doTotalCoePredio.ToString), String)
                lblTOTACOED.Text = CType(fun_Formato_Decimal_6_Decimales(doTotalCoeEdificio.ToString), String)
...
#Region "GotFocus"
    ...
    End Sub
    Private Sub cboCONDCOPR_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCONDCOPR.GotFocus
        strBARRESTA.Items(0).Text = cboCONDCOPR.AccessibleDescription
    End Sub
    Private Sub cboCONDCOED_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCONDCOED.GotFocus
        strBARRESTA.Items(0).Text = cboCONDCOED.AccessibleDescription
    End Sub
...
#Region "KeyPress"
    ...
    Private Sub txtFIPRARTE_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtFIPRARTE.KeyPress
        ...
        End If
    End Sub
    Private Sub cboCONDCOPR_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cboCONDCOPR.KeyPress
        If e.KeyChar = Convert.ToChar(Keys.Enter) Then
            txtFIPRCOPR.Focus()
        End If
    End Sub
    Private Sub txtFIPRCOPR_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtFIPRCOPR.KeyPress
        ...
        End If
    End Sub
    Private Sub cboCONDCOED_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cboCONDCOED.KeyPress
        If e.KeyChar = Convert.ToChar(Keys.Enter) Then
            txtFIPRCOED.Focus()
        End If
    End Sub
...
#Region "SelectedIndexChanged"
    ...
    Private Sub cboCONDCOPR_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboCONDCOPR.SelectedIndexChanged
        Dim seleccion As Integer

        seleccion = cboCONDCOPR.SelectedIndex

        Select Case seleccion
            Case 0 : txtCONDCOPR.Text = "like"
            Case 1 : txtCONDCOPR.Text = "="
            Case 2 : txtCONDCOPR.Text = ">"
            Case 3 : txtCONDCOPR.Text = "<"
            Case 4 : txtCONDCOPR.Text = ">="
            Case 5 : txtCONDCOPR.Text = "<="
            Case 6 : txtCONDCOPR.Text = "<>"
        End Select

    End Sub
    Private Sub cboCONDCOED_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboCONDCOED.SelectedIndexChanged
        Dim seleccion As Integer

        seleccion = cboCONDCOED.SelectedIndex

        Select Case seleccion
            Case 0 : txtCONDCOED.Text = "like"
            Case 1 : txtCONDCOED.Text = "="
            Case 2 : txtCONDCOED.Text = ">"
            Case 3 : txtCONDCOED.Text = "<"
            Case 4 : txtCONDCOED.Text = ">="
            Case 5 : txtCONDCOED.Text = "<="
            Case 6 : txtCONDCOED.Text = "<>"
        End Select
...
#Region "KeyDown"
    ...
    Private Sub cmdCONSULTAR_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cmdCONSULTAR.KeyDown, txtFIPRNUFI.KeyDown, txtFIPRDIRE.KeyDown, txtFIPRMUNI.KeyDown, txtFIPRCORR.KeyDown, txtFIPRBARR.KeyDown, txtFIPRMANZ.KeyDown, txtFIPRPRED.KeyDown, txtFIPREDIF.KeyDown, txtFIPRUNPR.KeyDown, txtFIPRCLSE.KeyDown, txtFIPRCASU.KeyDown, txtFIPRCAPR.KeyDown, txtFIPRMOAD.KeyDown, cboCONDCOPR.KeyDown, cboCONDCOED.KeyDown, txtFIPRARTE.KeyDown, txtFIPRESTA.KeyDown, dgvCONSULTA.KeyDown
...
#Region "Validated"
    ...
    Private Sub txtFIPRCOPR_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtFIPRCOPR.Validated
        If Trim(txtFIPRCOPR.Text) <> "" Then
            If Val(txtFIPRCOPR.Text) >= 0 Then
                txtFIPRCOPR.Text = CType(fun_Formato_Decimal_6_Decimales(txtFIPRCOPR.Text.ToString), String)
            End If
        End If
    End Sub
    Private Sub txtFIPRCOED_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtFIPRCOED.Validated
        If Trim(txtFIPRCOED.Text) <> "" Then
            If Val(txtFIPRCOED.Text) >= 0 Then
                txtFIPRCOED.Text = CType(fun_Formato_Decimal_6_Decimales(txtFIPRCOED.Text.ToString), String)
            End If
        End If
    End Sub
