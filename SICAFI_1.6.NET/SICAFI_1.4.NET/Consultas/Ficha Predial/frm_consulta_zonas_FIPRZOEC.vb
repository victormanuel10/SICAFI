...
Public Class frm_consulta_zonas_FIPRZOEC

    '=============================
    ' CONSULTA ZONAS FICHA PREDIAL
    '=============================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_consulta_zonas_FIPRZOEC
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_consulta_zonas_FIPRZOEC
        End If
...
#Region "VARIABLES LOCALES"
    ...
    Dim stFPZOZONA As String
    Dim stFPZOPORC As String
    Dim stFPZOESTA As String
    Dim stFPZODEPA As String
    ...
    Dim Guardar_stFPZOZONA As String
    Dim Guardar_stFPZOPORC As String
    Dim Guardar_stFPZOESTA As String
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_VerificarDatos()
        ...
        If Trim(txtFPZOZONA.Text) = "" Then
            stFPZOZONA = "%"
        Else
            stFPZOZONA = Trim(txtFPZOZONA.Text)
        End If

        If Trim(txtFPZOPORC.Text) = "" Then
            stFPZOPORC = "%"
        Else
            stFPZOPORC = Trim(txtFPZOPORC.Text)
        End If

        If Trim(txtFPZOESTA.Text) = "" Then
            stFPZOESTA = "%"
        Else
            stFPZOESTA = Trim(txtFPZOESTA.Text)
        End If
        ...
        Try
            ...
            While I < dgvCONSULTA.RowCount And SW = 0
                If dgvCONSULTA.CurrentRow.Cells(I).Selected Then
                    ...
                    txtFPZOZONA.Text = Trim(dgvCONSULTA.CurrentRow.Cells(1).Value.ToString())
                    txtFPZOPORC.Text = Trim(dgvCONSULTA.CurrentRow.Cells(2).Value.ToString())
                    txtFPZOESTA.Text = Trim(dgvCONSULTA.CurrentRow.Cells(3).Value.ToString())
                    ...
                    ' departameto
                    stFPZODEPA = Trim(dgvCONSULTA.CurrentRow.Cells(20).Value.ToString())
                    ...
                    If Me.rbdZONAECON.Checked = True Then
                        lblFPZOZONA.Text = CType(fun_Buscar_Lista_Valores_ZONAECON(Trim(stFPZODEPA), Trim(txtRESOMUNI.Text), Trim(txtFIPRCLSE.Text), Trim(txtFPZOZONA.Text)), String)
                    End If

                    If Me.rbdZONAFISI.Checked = True Then
                        lblFPZOZONA.Text = CType(fun_Buscar_Lista_Valores_ZONAFISI(Trim(stFPZODEPA), Trim(txtRESOMUNI.Text), Trim(txtFIPRCLSE.Text), Trim(txtFPZOZONA.Text)), String)
                    End If
    ...
    Private Sub pro_GuardarConsulta()
        ...
        Guardar_stFPZOZONA = Trim(txtFPZOZONA.Text)
        Guardar_stFPZOPORC = Trim(txtFPZOPORC.Text)
        Guardar_stFPZOESTA = Trim(txtFPZOESTA.Text)
    ...
    Private Sub pro_ObtenerConsulta()
        ...
        txtFPZOZONA.Text = Guardar_stFPZOZONA
        txtFPZOPORC.Text = Guardar_stFPZOPORC
        txtFPZOESTA.Text = Guardar_stFPZOESTA
    ...
    Private Sub cmdCONSULTAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCONSULTAR.Click
        ...
        Try
            ...
            If Me.rbdZONAECON.Checked = True Then
                ...
                ParametrosConsulta += "FpzeZoec as ZonaEcon, "
                ParametrosConsulta += "FpzePorc as Porcentaje, "
                ParametrosConsulta += "FpzeEsta as Estado, "
                ...
                ParametrosConsulta += "FpzeDepa as departam "
                ParametrosConsulta += "From FichPred, FiprZoec where "
                ...
                ParametrosConsulta += "FpzeZoec like '" & stFPZOZONA & "' and "
                ParametrosConsulta += "FpzePorc like '" & stFPZOPORC & "' and "
                ParametrosConsulta += "FpzeEsta like '" & stFPZOESTA & "' "
            ...
            If Me.rbdZONAFISI.Checked = True Then
                ...
                ParametrosConsulta += "Select "
                ParametrosConsulta += "FiprNufi as NroFicha, "
                ParametrosConsulta += "FpzfZofi as ZonaFisi, "
                ParametrosConsulta += "FpzfPorc as Porcentaje, "
                ParametrosConsulta += "FpzfEsta as Estado, "
                ParametrosConsulta += "FiprDire as Direccion, "
                ParametrosConsulta += "FiprMuni as Municio, "
                ParametrosConsulta += "FiprCorr as Corregi, "
                ParametrosConsulta += "FiprBarr as Barrio, "
                ...
                ParametrosConsulta += "FiprVige as Vigencia, "
                ParametrosConsulta += "FiprReso as Resoluci, "
                ParametrosConsulta += "FpzfDepa as departam "
                ...
                ParametrosConsulta += "FiprMoad like '" & stFIPRMOAD & "' and "
                ParametrosConsulta += "FiprEsta like '" & stFIPRESTA & "' and "
                ParametrosConsulta += "FpzfZofi like '" & stFPZOZONA & "' and "
                ParametrosConsulta += "FpzfPorc like '" & stFPZOPORC & "' and "
                ParametrosConsulta += "FpzfEsta like '" & stFPZOESTA & "' "
                ParametrosConsulta += "order by FiprNufi,FiprClse,FiprMuni,FiprCorr,FiprBarr,FiprManz,FiprPred,FiprEdif,FiprUnpr"
...
#Region "GotFocus"
    ...
    End Sub
    Private Sub txtFPZOZONA_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtFPZOZONA.GotFocus
        txtFPZOZONA.SelectionStart = 0
        txtFPZOZONA.SelectionLength = Len(txtFPZOZONA.Text)
        strBARRESTA.Items(0).Text = txtFPZOZONA.AccessibleDescription
    End Sub
    Private Sub txtFPZOPORC_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtFPZOPORC.GotFocus
        txtFPZOPORC.SelectionStart = 0
        txtFPZOPORC.SelectionLength = Len(txtFPZOPORC.Text)
        strBARRESTA.Items(0).Text = txtFPZOPORC.AccessibleDescription
    End Sub
    Private Sub txtFPZOESTA_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtFPZOESTA.GotFocus
        txtFPZOESTA.SelectionStart = 0
        txtFPZOESTA.SelectionLength = Len(txtFPZOESTA.Text)
        strBARRESTA.Items(0).Text = txtFPZOESTA.AccessibleDescription
    End Sub
...
#Region "KeyPress"
    ...
    Private Sub txtFIPRESTA_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtFIPRESTA.KeyPress
        ...
        End If
    End Sub
    Private Sub txtFPZOZONA_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtFPZOZONA.KeyPress
        If e.KeyChar = Convert.ToChar(Keys.Enter) Then
            txtFPZOPORC.Focus()
        End If
    End Sub
    Private Sub txtFPZOPORC_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtFPZOPORC.KeyPress
        If e.KeyChar = Convert.ToChar(Keys.Enter) Then
            txtFPZOESTA.Focus()
        End If
    End Sub
    Private Sub txtFPZOESTA_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtFPZOESTA.KeyPress
        If e.KeyChar = Convert.ToChar(Keys.Enter) Then
            txtFIPRNUFI.Focus()
        End If
    End Sub
...
#Region "KeyDown"
    ...
    Private Sub cmdCONSULTAR_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cmdCONSULTAR.KeyDown, txtFIPRNUFI.KeyDown, txtFIPRDIRE.KeyDown, txtFIPRMUNI.KeyDown, txtFIPRCORR.KeyDown, txtFIPRBARR.KeyDown, txtFIPRMANZ.KeyDown, txtFIPRPRED.KeyDown, txtFIPREDIF.KeyDown, txtFIPRUNPR.KeyDown, txtFIPRCLSE.KeyDown, txtFIPRCASU.KeyDown, txtFIPRCAPR.KeyDown, txtFIPRMOAD.KeyDown, txtFIPRESTA.KeyDown, dgvCONSULTA.KeyDown, txtFPZOZONA.KeyDown, txtFPZOPORC.KeyDown, txtFPZOESTA.KeyDown
...
#Region "Validated"
    ...
    Private Sub txtFIPRMOAD_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtFIPRMOAD.Validated
        ...
        End If
    End Sub
    Private Sub txtFPZOZONA_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtFPZOZONA.Validated
        If Trim(txtFPZOZONA.Text) = "" Then
            lblFPZOZONA.Text = ""
        Else
            If Me.rbdZONAECON.Checked = True Then
                Me.lblFPZOZONA.Text = CType(fun_Buscar_Lista_Valores_ZONAECON(vp_Departamento, Trim(txtFIPRMUNI.Text), Trim(txtFIPRCLSE.Text), Trim(txtFPZOZONA.Text)), String)

            ElseIf Me.rbdZONAFISI.Checked = True Then
                Me.lblFPZOZONA.Text = CType(fun_Buscar_Lista_Valores_ZONAFISI(vp_Departamento, Trim(txtFIPRMUNI.Text), Trim(txtFIPRCLSE.Text), Trim(txtFPZOZONA.Text)), String)
