...
Public Class frm_insertar_archivo_RESOLICE

    '=================================================
    '*** INSERTAR ARCHIVO RESOLUCIONES Y LICENCIAS ***
    '=================================================
...
#Region "VARIABLE"
    ...
    Dim vl_stLIRACLEN As String = ""
    Dim lv_inLIRANURA As Integer = 0
    Dim lv_inLIRAVIGE As Integer = 0
...
#Region "CONSTRUCTOR"
    ...
    Public Sub New(ByVal stLIRACLEN As String, _
                   ByVal inLIRANURA As Integer, _
                   ByVal inLIRAVIGE As Integer)

        vl_stLIRACLEN = stLIRACLEN
        lv_inLIRANURA = inLIRANURA
        lv_inLIRAVIGE = inLIRAVIGE
    ...
    Private Function fun_consultarRutaDestino() As String
        ...
        Try
            ...
            If tblRutas.Rows.Count > 0 Then
                ...
                ' directorio pricipal
                stRuta = Trim(tblRutas.Rows(0).Item("RUTARUTA")) & "\" & Trim(vl_stLIRACLEN) & "-" & lv_inLIRANURA & "-" & lv_inLIRAVIGE & "\" & Me.lstLISTADO_DOCUMENTOS.SelectedItem
