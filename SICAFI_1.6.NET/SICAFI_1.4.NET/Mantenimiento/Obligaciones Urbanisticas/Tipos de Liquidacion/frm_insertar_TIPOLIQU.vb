...
Public Class frm_insertar_TIPOLIQU
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_TIPOLIQU(Me.txtTILICODI)
            ...
            If boLLAVEPRIMARIA = True And boTILICODI = True And boTILIDESC = True And boTILIESTA = True Then

                Dim objdatos22 As New cla_TIPOLIQU

                If (objdatos22.fun_Insertar_MANT_TIPOLIQU(Me.txtTILICODI.Text, Me.txtTILIDESC.Text, Me.cboTILIESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_TIPOLIQU_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
