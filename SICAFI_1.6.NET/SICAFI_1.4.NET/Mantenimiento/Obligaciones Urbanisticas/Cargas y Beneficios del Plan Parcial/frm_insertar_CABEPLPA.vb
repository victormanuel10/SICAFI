...
Public Class frm_insertar_CABEPLPA
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_CABEPLPA(Me.txtCBPPCODI)
            ...
            If boLLAVEPRIMARIA = True And boCBPPCODI = True And boCBPPDESC = True And boCBPPESTA = True Then

                Dim objdatos22 As New cla_CABEPLPA

                If (objdatos22.fun_Insertar_MANT_CABEPLPA(Me.txtCBPPCODI.Text, Me.txtCBPPDESC.Text, Me.cboCBPPESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_CABEPLPA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
