...
Public Class frm_insertar_COFPPLPA

    '====================================================
    '*** INSERTAR CONTROL FORMA DE PAGO PLAN PARCIAL ***
    '====================================================
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_COFPPLPA(Me.txtCOFPCODI)
            ...
            If boLLAVEPRIMARIA = True And boCOFPCODI = True And boCOFPDESC = True And boCOFPESTA = True Then

                Dim objdatos22 As New cla_COFPPLPA

                If (objdatos22.fun_Insertar_MANT_COFPPLPA(Me.txtCOFPCODI.Text, Me.txtCOFPDESC.Text, Me.cboCOFPESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_COFPPLPA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
