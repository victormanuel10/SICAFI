...
Public Class frm_insertar_PLANPARC

    '======================================
    '*** INSERTAR PROYECTO PLAN PARCIAL ***
    '======================================
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_PLANPARC(Me.txtPLPANURE, Me.txtPLPAFERE)
            ...
            If boLLAVEPRIMARIA = True And _
                boPLPANURE = True And _
                boPLPAFERE = True And _
                boPLPADESC = True And _
                boPLPAESTA = True Then

                Dim objdatos22 As New cla_PLANPARC

                If (objdatos22.fun_Insertar_MANT_PLANPARC(Me.txtPLPANURE.Text, Me.txtPLPAFERE.Text, Me.txtPLPADESC.Text, Me.cboPLPAESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_PLANPARC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
