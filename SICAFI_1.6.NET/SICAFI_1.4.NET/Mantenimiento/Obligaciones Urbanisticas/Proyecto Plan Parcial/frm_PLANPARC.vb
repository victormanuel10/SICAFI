...
Public Class frm_PLANPARC

    '================================================
    '*** MANTENIMIENTO PROYECTOS DEL PLAN PARCIAL ***
    '================================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_PLANPARC
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_PLANPARC
        End If
    ...
    Private Sub pro_Reconsultar()
        ...
        Try
            ...
            ElseIf boCONSULTA = True Then
                Me.BindingSource_PLANPARC_1.DataSource = objdatos.fun_Buscar_ID_X_CONSULTA_PARAMETRIZADA_MANT_PLANPARC(vp_inConsulta)
            End If
            ...
            '==================================================
            '*** CONFIGURA OBJETOS DEL FORMULARIO MAPLPAO ***
            '==================================================
            ...
            Me.dgvPLANPARC.Columns("PLPANURE").Width = 161
            Me.dgvPLANPARC.Columns("PLPAFERE").Width = 161
            Me.dgvPLANPARC.Columns("PLPADESC").Width = 400
            Me.dgvPLANPARC.Columns("PLPAESTA").Width = 107

            Me.strBARRESTA.Items(2).Text = "Registros : " & BindingSource_PLANPARC_1.Count

            '==================================================
            '*** ASIGNA LOS PRIVILEGIOS DE LA BARRA DE MENU ***
            '==================================================

            Dim ContarRegistros As Integer = Me.BindingSource_PLANPARC_1.Count
...
#Region "MENU"
    ...
    Private Sub cmdAGREGAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAGREGAR.Click
        ...
        Try
            frm_insertar_PLANPARC.ShowDialog()
    ...
    Private Sub cmdELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdELIMINAR.Click
        ...
        Try
            If MessageBox.Show("¿ Desea eliminar el registro seleccionado ?", "Mensaje...", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                ...
                If objdatos.fun_Eliminar_MANT_PLANPARC(Integer.Parse(Me.dgvPLANPARC.SelectedRows.Item(0).Cells(0).Value.ToString())) = True Then
                    boCONSULTA = False
                    pro_Reconsultar()
                Else
    ...
    Private Sub cmdMODIFICAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdMODIFICAR.Click
        ...
        Try
            Dim frm_modificar_PLANPARC As New frm_modificar_PLANPARC(Integer.Parse(Me.dgvPLANPARC.SelectedRows.Item(0).Cells(0).Value.ToString()))
            frm_modificar_PLANPARC.ShowDialog()
    ...
    Private Sub cmdCONSULTAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCONSULTAR.Click
        ...
        Try
            ...
            frm_consultar_PLANPARC.ShowDialog()
...
#Region "KeyDown"
    ...
    Private Sub dgv_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dgvPLANPARC.KeyDown
        '===============================================================================================
        '*** INSERTAR REGISTROS ***
        '===============================================================================================
...
#Region "GotFocus"
    ...
    Private Sub dgv_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvPLANPARC.GotFocus
