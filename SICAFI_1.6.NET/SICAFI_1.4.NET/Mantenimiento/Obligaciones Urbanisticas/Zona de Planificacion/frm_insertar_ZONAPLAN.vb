...
Public Class frm_insertar_ZONAPLAN

    '====================================
    '*** INSERTAR TIPO DE LIQUIDACION ***
    '====================================
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_ZONAPLAN(Me.txtZOPLCODI)
            ...
            If boLLAVEPRIMARIA = True And boZOPLCODI = True And boZOPLDESC = True And boZOPLESTA = True Then

                Dim objdatos22 As New cla_ZONAPLAN

                If (objdatos22.fun_Insertar_MANT_ZONAPLAN(Me.txtZOPLCODI.Text, Me.txtZOPLDESC.Text, Me.cboZOPLESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_ZONAPLAN_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
...
#Region "GotFocus"
    ...
    Private Sub txt_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtZOPLCODI.GotFocus, txtZOPLDESC.GotFocus, txtZOPLDESC.GotFocus
    ...
    Private Sub cmd_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.GotFocus, cmdSALIR.GotFocus
        pp_pro_DescripcionCampo(Me.strBARRESTA.Items(0), sender)
    End Sub
    Private Sub cbo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboZOPLESTA.GotFocus, cboZOPLESTA.GotFocus
        pp_pro_DescripcionCampo(Me.strBARRESTA.Items(0), sender)
    End Sub
