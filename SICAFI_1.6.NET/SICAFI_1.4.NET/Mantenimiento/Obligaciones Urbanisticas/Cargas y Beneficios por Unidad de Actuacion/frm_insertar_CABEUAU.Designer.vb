...
Partial Class frm_insertar_CABEUAU
    ...
    Private Sub InitializeComponent()
        ...
        Me.fraUAUPLPA.Text = "INSERTAR CARGAS Y BENEFICIOS POR UNIDAD DE ACTUACIÓN"
        '
        'cboCBAUPLPA
        '
