...
Public Class frm_insertar_DENSIDAD
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_DENSIDAD(Me.txtDENSCECA)

            Dim objVerifica As New cla_Verificar_Dato

            Dim boDENSCODI As Boolean = objVerifica.fun_Verificar_Dato_Vacio_Y_Numerico(Me.txtDENSCECA)
            Dim boDENSDESC As Boolean = objVerifica.fun_Verificar_Dato_Vacio_Y_Decimal(Me.txtDENSDENS)
            Dim boDENSESTA As Boolean = objVerifica.fun_Verificar_Dato_Lleno(Me.cboDENSESTA)

            ' verifica los datos del formulario 
            If boLLAVEPRIMARIA = True And boDENSCODI = True And boDENSDESC = True And boDENSESTA = True Then

                Dim objdatos22 As New cla_DENSIDAD

                If (objdatos22.fun_Insertar_MANT_DENSIDAD(Me.txtDENSCECA.Text, Me.txtDENSDENS.Text, Me.cboDENSESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_DENSIDAD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
...
#Region "Click"
    ...
    Private Sub cboMOLIESTA_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboDENSESTA.Click, cboDENSESTA.Click
