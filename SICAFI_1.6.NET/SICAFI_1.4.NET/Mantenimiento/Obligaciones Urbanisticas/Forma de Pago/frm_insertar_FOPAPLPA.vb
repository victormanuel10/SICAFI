...
Public Class frm_insertar_FOPAPLPA

    '===========================================
    '*** INSERTAR FORMA DE PAGO PLAN PARCIAL ***
    '===========================================
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_FOPAPLPA(Me.txtFPPPCODI)
            ...
            If boLLAVEPRIMARIA = True And boFPPPCODI = True And boFPPPDESC = True And boFPPPESTA = True Then

                Dim objdatos22 As New cla_FOPAPLPA

                If (objdatos22.fun_Insertar_MANT_FOPAPLPA(Me.txtFPPPCODI.Text, Me.txtFPPPDESC.Text, Me.cboFPPPESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_FOPAPLPA_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
