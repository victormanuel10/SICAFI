...
Public Class frm_insertar_CLASOBUR
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_CLASOBUR(Me.txtCLOUCODI)
            ...
            If boLLAVEPRIMARIA = True And boCLOUCODI = True And boCLOUDESC = True And boCLOUESTA = True Then

                Dim objdatos22 As New cla_CLASOBUR

                If (objdatos22.fun_Insertar_MANT_CLASOBUR(Me.txtCLOUCODI.Text, Me.txtCLOUDESC.Text, Me.cboCLOUESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_CLASOBUR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
