...
Public Class frm_modificar_TARIALPU

    '==========================================
    '*** MODIFICAR TARIFA ALUMBRADO PUBLICO ***
    '==========================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            ...
            Me.cboTAAPDEPA.DataSource = objdatos1.fun_Consultar_CAMPOS_MANT_DEPARTAMENTO
            Me.cboTAAPDEPA.DisplayMember = "DEPADESC"
            Me.cboTAAPDEPA.ValueMember = "DEPACODI"

            Dim objdatos2 As New cla_CLASSECT

            Me.cboTAAPCLSE.DataSource = objdatos2.fun_Consultar_CAMPOS_MANT_CLASSECT
            Me.cboTAAPCLSE.DisplayMember = "CLSEDESC"
            Me.cboTAAPCLSE.ValueMember = "CLSECODI"

            Dim objdatos27 As New cla_VIGENCIA

            Me.cboTAAPVIGE.DataSource = objdatos27.fun_Consultar_CAMPOS_VIGENCIA
            Me.cboTAAPVIGE.DisplayMember = "VIGEDESC"
            Me.cboTAAPVIGE.ValueMember = "VIGECODI"

            Dim objdatos28 As New cla_TIPOCALI

            Me.cboTAAPTIPO.DataSource = objdatos28.fun_Consultar_CAMPOS_MANT_TIPOCALI
            Me.cboTAAPTIPO.DisplayMember = "TICADESC"
            Me.cboTAAPTIPO.ValueMember = "TICACODI"

            Dim objdatos23 As New cla_ESTRATO

            Me.cboTAAPESTR.DataSource = objdatos23.fun_Consultar_CAMPOS_MANT_ESTRATO
            Me.cboTAAPESTR.DisplayMember = "ESTRDESC"
            Me.cboTAAPESTR.ValueMember = "ESTRCODI"

            Dim objdatos As New cla_ESTADO

            Me.cboTAAPESTA.DataSource = objdatos.fun_Consultar_TODOS_LOS_ESTADOS
            Me.cboTAAPESTA.DisplayMember = "ESTADESC"
            Me.cboTAAPESTA.ValueMember = "ESTACODI"

            Dim objdatos3 As New cla_TARIALPU
            Dim tbl As New DataTable

            tbl = objdatos3.fun_Buscar_ID_TARIALPU(inID_REGISTRO)

            Me.cboTAAPDEPA.SelectedValue = tbl.Rows(0).Item("TAAPDEPA")

            Dim objdatos7 As New cla_MUNICIPIO

            Me.cboTAAPMUNI.DataSource = objdatos7.fun_Consultar_CAMPOS_MANT_MUNICIPIO
            Me.cboTAAPMUNI.DisplayMember = "MUNIDESC"
            Me.cboTAAPMUNI.ValueMember = "MUNICODI"

            Me.cboTAAPMUNI.SelectedValue = tbl.Rows(0).Item("TAAPMUNI")
            Me.cboTAAPCLSE.SelectedValue = tbl.Rows(0).Item("TAAPCLSE")
            Me.cboTAAPVIGE.SelectedValue = tbl.Rows(0).Item("TAAPVIGE")
            Me.cboTAAPTIPO.SelectedValue = tbl.Rows(0).Item("TAAPTIPO")

            Me.txtTAAPTARE.Text = fun_Formato_Mascara_Pesos_Enteros(Trim(tbl.Rows(0).Item("TAAPTARE")))
            Me.txtTAAPTACO.Text = fun_Formato_Mascara_Pesos_Enteros(Trim(tbl.Rows(0).Item("TAAPTACO")))
            Me.txtTAAPTAIN.Text = fun_Formato_Mascara_Pesos_Enteros(Trim(tbl.Rows(0).Item("TAAPTAIN")))

            Me.cboTAAPESTR.SelectedValue = tbl.Rows(0).Item("TAAPESTR")
            Me.txtTAAPTA01.Text = Trim(tbl.Rows(0).Item("TAAPTA01"))
            Me.txtTAAPTA02.Text = Trim(tbl.Rows(0).Item("TAAPTA02"))
            Me.txtTAAPTA03.Text = Trim(tbl.Rows(0).Item("TAAPTA03"))
            Me.txtTAAPTA04.Text = Trim(tbl.Rows(0).Item("TAAPTA04"))
            Me.txtTAAPTA05.Text = Trim(tbl.Rows(0).Item("TAAPTA05"))

            Me.txtTAAPAVIN.Text = fun_Formato_Mascara_Pesos_Enteros(Trim(tbl.Rows(0).Item("TAAPAVIN")))
            Me.txtTAAPAVFI.Text = fun_Formato_Mascara_Pesos_Enteros(Trim(tbl.Rows(0).Item("TAAPAVFI")))

            Me.cboTAAPESTA.SelectedValue = tbl.Rows(0).Item("TAAPESTA")

            Dim boTAAPDEPA As Boolean = fun_Buscar_Dato_DEPARTAMENTO(Me.cboTAAPDEPA.SelectedValue)
            Dim boTAAPMUNI As Boolean = fun_Buscar_Dato_MUNICIPIO(Me.cboTAAPDEPA.SelectedValue, Me.cboTAAPMUNI.SelectedValue)
            Dim boTAAPCLSE As Boolean = fun_Buscar_Dato_CLASSECT(Me.cboTAAPCLSE.SelectedValue)
            Dim boTAAPVIGE As Boolean = fun_Buscar_Dato_VIGENCIA(Me.cboTAAPVIGE.SelectedValue)
            Dim boTAAPTIPO As Boolean = fun_Buscar_Dato_TIPOCALI(Me.cboTAAPTIPO.SelectedValue)
            Dim boTAAPESTR As Boolean = fun_Buscar_Dato_ESTRATO(Me.cboTAAPESTR.SelectedValue)

            If boTAAPDEPA = True OrElse _
               boTAAPMUNI = True OrElse _
               boTAAPCLSE = True OrElse _
               boTAAPVIGE = True OrElse _
               boTAAPTIPO = True OrElse _
               boTAAPESTR = True Then
        ...
        Try
            ...
            If boTAAPDEPA = True And _
               ...
               boTAAPESTA = True Then
                ...
                If (objdatos22.fun_Actualizar_TARIALPU(inID_REGISTRO, _
                                                         Me.cboTAAPDEPA.SelectedValue, _
