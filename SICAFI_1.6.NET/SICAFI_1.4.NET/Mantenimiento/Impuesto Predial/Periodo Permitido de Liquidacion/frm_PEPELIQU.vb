...
Public Class frm_PEPELIQU
    ...
    '========================================
    '*** PERIODO PERMITIDO DE LIQUIDACIÓN ***
    '========================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_Reconsultar()
        Try
            ...
            Me.dgvPEPELIQU_2.Columns("PPLIDESC").HeaderText = "Descripción"
            Me.dgvPEPELIQU_2.Columns("PPLIHIAV").HeaderText = "Historico avalúo"
            Me.dgvPEPELIQU_2.Columns("PPLIHILI").HeaderText = "Historico liquidación"
