...
Public Class frm_modificar_TARIRAAV

    '==============================================
    '*** MODIFICAR TARIFA POR RANGOS DE AVALUOS ***
    '==============================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            ...
            Dim objdatos66 As New cla_TIPOCALI

            Me.cboTARATIPO.DataSource = objdatos66.fun_Consultar_CAMPOS_MANT_TIPOCALI
            Me.cboTARATIPO.DisplayMember = "TICADESC"
            Me.cboTARATIPO.ValueMember = "TICACODI"
            ...
            Dim objdatos3 As New cla_TARIRAAV
            Dim tbl As New DataTable

            tbl = objdatos3.fun_Buscar_ID_TARIRAAV(inID_REGISTRO)
            ...
            Me.cboTARATIPO.SelectedValue = tbl.Rows(0).Item("TARATIPO")
            ...
            Dim boTARATIPO As Boolean = fun_Buscar_Dato_TIPOCALI(Me.cboTARATIPO.SelectedValue)
        ...
        Try
            ...
            If boTARADEPA = True And _
               ...
               boTARAESTA = True Then
                ...
                If (objdatos22.fun_Actualizar_TARIRAAV(inID_REGISTRO, _
...
#Region "KeyPress"
    ...
    Private Sub txt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cboTARADEPA.KeyPress, cboTARAMUNI.KeyPress, cboTARACLSE.KeyPress, cboTARAVIGE.KeyPress, cboTARADEEC.KeyPress, txtTARATARI.KeyPress, txtTARAAVIN.KeyPress, txtTARAAVFI.KeyPress, cboTARAESTA.KeyPress, cboTARATIPO.KeyPress
