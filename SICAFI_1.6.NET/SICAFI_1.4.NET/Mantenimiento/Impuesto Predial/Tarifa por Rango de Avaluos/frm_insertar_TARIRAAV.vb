...
Public Class frm_insertar_TARIRAAV
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        Me.cboTARATIPO.DataSource = New DataTable
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_TARIRAAV(Me.cboTARADEPA, _
                                                                                           Me.cboTARAMUNI, _
                                                                                           Me.cboTARACLSE, _
                                                                                           Me.cboTARAVIGE, _
                                                                                           Me.cboTARADEEC, _
            ...
            Dim boTARATIPO As Boolean = objVerifica.fun_Verificar_Dato_Lleno(Me.cboTARATIPO)
            ...
            If boLLAVEPRIMARIA = True And _
               ...
               boTARATIPO = True And _
               boTARAAVIN = True And _
               boTARAAVFI = True And _
               boTARAESTA = True Then

                Dim objdatos22 As New cla_TARIRAAV

                If (objdatos22.fun_Insertar_TARIRAAV(Me.cboTARADEPA.SelectedValue, _
                                                         ...
                                                         Me.cboTARATIPO.SelectedValue, _
...
#Region "Load"
    ...
    Private Sub frm_insertar_TARIRAAV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
        Me.cboTARADEPA.Focus()
    End Sub
...
#Region "KeyPress"
    ...
    Private Sub txt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cboTARADEPA.KeyPress, cboTARAMUNI.KeyPress, cboTARACLSE.KeyPress, cboTARAVIGE.KeyPress, cboTARADEEC.KeyPress, txtTARATARI.KeyPress, txtTARAAVIN.KeyPress, txtTARAAVFI.KeyPress, cboTARAESTA.KeyPress, cboTARATIPO.KeyPress, cboTARAESTR.KeyPress
...
#Region "KeyDown"
    ...
    Private Sub cboTARAESTR_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboTARAESTR.KeyDown
        ...
        End If
    End Sub
    Private Sub cboTARAtipo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboTARATIPO.KeyDown
        If e.KeyCode = Keys.Up Or e.KeyCode = Keys.Down Then
            fun_Cargar_ComboBox_Con_Datos_Activos_TIPOCALI_Descripcion(Me.cboTARATIPO, Me.cboTARATIPO.SelectedIndex)
        End If
    End Sub
...
#Region "GotFocus"
    ...
    Private Sub cmd_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.GotFocus, cmdSALIR.GotFocus
        pp_pro_DescripcionCampo(Me.strBARRESTA.Items(0), sender)
    End Sub
    Private Sub cbo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboTARADEPA.GotFocus, cboTARAMUNI.GotFocus, cboTARACLSE.GotFocus, cboTARAVIGE.GotFocus, cboTARADEEC.GotFocus, cboTARAESTA.GotFocus, cboTARAESTR.GotFocus, cboTARATIPO.GotFocus
        pp_pro_DescripcionCampo(Me.strBARRESTA.Items(0), sender)
    End Sub
...
#Region "SelectedIndexChanged"
    ...
    End Sub
    Private Sub cboTARATIPO_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboTARATIPO.SelectedIndexChanged
        Me.lblTARATIPO.Text = CType(fun_Buscar_Lista_Valores_TIPOCALI_Codigo(Me.cboTARATIPO), String)
    End Sub
...
#Region "Click"
    ...
    Private Sub cboTARAESTR_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboTARAESTR.Click
        fun_Cargar_ComboBox_Con_Datos_Activos_ESTRATO_Descripcion(Me.cboTARAESTR, Me.cboTARAESTR.SelectedIndex)
    End Sub
    Private Sub cboTARATIPO_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboTARATIPO.Click
        fun_Cargar_ComboBox_Con_Datos_Activos_TIPOCALI_Descripcion(Me.cboTARATIPO, Me.cboTARATIPO.SelectedIndex)
    End Sub
...
#Region "Validated"
    ...
    Private Sub txtTAPEAVFI_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtTARATARI.Validated, txtTARAAVIN.Validated, txtTARAAVFI.Validated, txtTARATARI.Validated

        If Trim(sender.text) = "" Then
            sender.text = 0
        Else
            If fun_Verificar_Dato_Numerico_Evento_Validated(Me.txtTARATARI.Text) = True Then
                Me.txtTARATARI.Text = fun_Formato_Mascara_Pesos_Enteros(Me.txtTARATARI.Text)
            End If
            ...
            If fun_Verificar_Dato_Decimal_Evento_Validated(Me.txtTARATARI.Text) = True Then
