...
Public Class frm_modificar_TIPOAFOR

    '===============================
    '*** MODIFICAR TIPO DE AFORO ***
    '===============================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Me.cboTIAFESTA.DataSource = objdatos.fun_Consultar_TODOS_LOS_ESTADOS
        Me.cboTIAFESTA.DisplayMember = "ESTADESC"
        Me.cboTIAFESTA.ValueMember = "ESTACODI"

        Dim objdatos1 As New cla_TIPOAFOR
        Dim tbl As New DataTable

        tbl = objdatos1.fun_Buscar_ID_MANT_TIPOAFOR(inID_REGISTRO)

        Me.txtTIAFCODI.Text = Trim(tbl.Rows(0).Item(1))
        Me.txtTIAFDESC.Text = Trim(tbl.Rows(0).Item(2))
        Me.cboTIAFESTA.SelectedValue = tbl.Rows(0).Item(3)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        Try
            ...
            If boTIAFCODI = True And boTIAFDESC = True And boTIAFESTA = True Then

                Dim objdatos As New cla_TIPOAFOR

                If objdatos.fun_Actualizar_MANT_TIPOAFOR(inID_REGISTRO, Me.txtTIAFCODI.Text, Me.txtTIAFDESC.Text, Me.cboTIAFESTA.SelectedValue) = True Then
                    Me.txtTIAFDESC.Focus()
                    Me.Close()
