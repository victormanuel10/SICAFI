...
Public Class frm_insertar_MODOLIQU

    '====================================
    '*** INSERTAR MODO DE LIQUIDACIÓN ***
    '====================================
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MODOLIQU(Me.txtMOLICODI)
            ...
            If boLLAVEPRIMARIA = True And boMOLICODI = True And boMOLIDESC = True And boMOLIESTA = True Then
                ...
                Dim objdatos22 As New cla_MODOLIQU

                If (objdatos22.fun_Insertar_MANT_MODOLIQU(Me.txtMOLICODI.Text, Me.txtMOLIDESC.Text, Me.cboMOLIESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_MODOLIQU_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
...
#Region "KeyDown"
    ...
    Private Sub cboESTRESTA_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboMOLIESTA.KeyDown
        If e.KeyCode = Keys.Up Or e.KeyCode = Keys.Down Then
            fun_Cargar_ComboBox_Con_Datos_Activos_ESTADO(Me.cboMOLIESTA, Me.cboMOLIESTA.SelectedIndex)
        End If
    End Sub
...
#Region "Validated"
    ...
    Private Sub txtCAPRCODI_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMOLICODI.Validated

        If fun_Verificar_Campos_Llenos_1_DATOS(Me.txtMOLICODI.Text) = True Then

            Dim obVerifica As New cla_Verificar_Dato
            If obVerifica.fun_Verificar_Dato_Vacio_Y_Numerico(Me.txtMOLICODI) = True Then

                Dim obDatos As New cla_MODOLIQU
                obDatos.fun_Verifica_llave_Primaria_MODOLIQU(Me.txtMOLICODI)
            End If
