...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_Reconsultar()
        Try
            ...
            Me.dgvVIGEACTU.Columns("VIACRESO").HeaderText = "Resolución"
            Me.dgvVIGEACTU.Columns("VIACDESC").HeaderText = "Descripción"
            Me.dgvVIGEACTU.Columns("VIACVIAC").HeaderText = "Vigencia actualización"
            Me.dgvVIGEACTU.Columns("VIACPOIN").HeaderText = "Incremento anual"
            Me.dgvVIGEACTU.Columns("VIACACTU").HeaderText = "Actualización"
            Me.dgvVIGEACTU.Columns("VIACCONS").HeaderText = "Conservación"
