...
Public Class frm_insertar_TRATURBA

    '==========================================
    '*** INSERTAR TRATAMIENTOS URBANISTICOS ***
    '==========================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        pp_pro_LimpiarCampos(fraTRATURBA)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_TRATURBA(Me.txtTRURCODI)
            ...
            If boLLAVEPRIMARIA = True And _
               boTRURCODI = True And _
               boTRURDESC = True And _
               boTRURESTA = True Then

                Dim objdatos22 As New cla_TRATURBA

                If (objdatos22.fun_Insertar_MANT_TRATURBA(Me.txtTRURCODI.Text, _
