...
Partial Class frm_insertar_RANGARTE
    ...
    Private Sub InitializeComponent()
        ...
        Me.fraZONAECONOMICA.Text = "INSERTA RANGO DE AREA DE TERRENO"
        '
        'txtRAATATFI
        '
