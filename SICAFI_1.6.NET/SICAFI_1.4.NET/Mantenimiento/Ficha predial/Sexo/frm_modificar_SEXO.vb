...
Public Class frm_modificar_SEXO
...
#Region "PROCEDIMIENTOS"
    ...
    Public Sub pro_inicializarControles()
        ...
        tbl = objdatos1.fun_Buscar_ID_MANT_SEXO(id)

        txtSEXOCODI.Text = Trim(tbl.Rows(0).Item(1))
        txtSEXODESC.Text = Trim(tbl.Rows(0).Item(2))
        cboSEXOESTA.SelectedValue = tbl.Rows(0).Item(3)
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        Try
            ...
            Else
                ...
                If (objdatos.fun_Actualizar_MANT_SEXO(id, txtSEXOCODI.Text, txtSEXODESC.Text, cboSEXOESTA.SelectedValue)) Then
