...
Public Class cla_SEXO
    ...
    Public Function fun_Consultar_MANT_SEXO() As DataTable
        ...
        Try
            ...
            conexion.Open()
            ejecutar = New SqlCommand("Consultar_MANT_SEXO", conexion)
    ...
    Public Function fun_Consultar_CAMPOS_MANT_SEXO() As DataTable
        ...
        Try
            ...
            conexion = New SqlConnection(Global.SICAFI.My.Settings.SICAFIConnectionString1)
            conexion.Open()
            ejecutar = New SqlCommand("Consultar_CAMPOS_MANT_SEXO", conexion)
            ejecutar.CommandTimeout = 360
            ejecutar.CommandType = CommandType.StoredProcedure
            adapter.SelectCommand = ejecutar
            adapter.Fill(dt)
    ...
    Public Function fun_Consultar_MANT_SEXO_X_ESTADO() As DataTable
        ...
        Try
            ...
            conexion = New SqlConnection(Global.SICAFI.My.Settings.SICAFIConnectionString1)
            conexion.Open()
            ejecutar = New SqlCommand("Consultar_MANT_SEXO_X_ESTADO", conexion)
            ejecutar.CommandTimeout = 360
            ejecutar.CommandType = CommandType.StoredProcedure
            adapter.SelectCommand = ejecutar
            adapter.Fill(dt)
    ...
    Public Function fun_Insertar_MANT_SEXO(ByVal inSEXOCODI As Integer, _
        ...
        Try
            ...
            conexion.Open()
            ejecutar = New SqlCommand("insertar_MANT_SEXO", conexion)
            ejecutar.CommandTimeout = 360
            ejecutar.CommandType = CommandType.StoredProcedure

            ejecutar.Parameters.Add("@SEXOCODI", SqlDbType.Int, 4).Value = inSEXOCODI
            ejecutar.Parameters.Add("@SEXODESC", SqlDbType.NChar, 50).Value = stSEXODESC
            ejecutar.Parameters.Add("@SEXOESTA", SqlDbType.NChar, 10).Value = stSEXOESTA
    ...
    Public Function fun_Eliminar_MANT_SEXO(ByVal inSEXOIDRE As Integer) As Boolean
        ...
        Try
            conexion = New SqlConnection(Global.SICAFI.My.MySettings.Default.SICAFIConnectionString1)
            conexion.Open()
            ejecutar = New SqlCommand("eliminar_MANT_SEXO", conexion)
            ejecutar.CommandTimeout = 360
            ejecutar.CommandType = CommandType.StoredProcedure

            ejecutar.Parameters.Add("@SEXOIDRE", SqlDbType.Int, 4).Value = inSEXOIDRE
    ...
    Public Function fun_Actualizar_MANT_SEXO(ByVal inSEXOIDRE As Integer, _
        ...
        Try
            conexion = New SqlConnection(Global.SICAFI.My.MySettings.Default.SICAFIConnectionString1)
            conexion.Open()
            ejecutar = New SqlCommand("actualizar_MANT_SEXO", conexion)
            ejecutar.CommandTimeout = 360
            ejecutar.CommandType = CommandType.StoredProcedure
    ...
    ''' </summary>
    Public Function fun_Buscar_ID_MANT_SEXO(ByVal Id As Integer) As DataTable
        ...
        Try
            ...
            conexion = New SqlConnection(Global.SICAFI.My.MySettings.Default.SICAFIConnectionString1)
            conexion.Open()
            ejecutar = New SqlCommand("buscar_ID_MANT_SEXO", conexion)
            ejecutar.CommandTimeout = 360

            ejecutar.Parameters.Add("@SEXOIDRE", SqlDbType.Int, 4).Value = Id
    ...
    ''' </summary>
    Public Function fun_Buscar_CODIGO_MANT_SEXO(ByVal IdCodigo As Integer) As DataTable
        ...
        Try
            ...
            conexion = New SqlConnection(Global.SICAFI.My.MySettings.Default.SICAFIConnectionString1)
            conexion.Open()
            ejecutar = New SqlCommand("buscar_CODIGO_MANT_SEXO", conexion)
            ejecutar.CommandTimeout = 360

            ejecutar.Parameters.Add("@SEXOCODI", SqlDbType.Int, 4).Value = IdCodigo
