...
Public Class frm_consultar_CARAPRED

    '=========================================
    '*** CONSULTA CARACTERISTICA DE PREDIO ***
    '=========================================
...
#Region "MENU"
    ...
    Private Sub cmdCONSULTAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCONSULTAR.Click
        Try
            ...
            tbl_Consulta1 = objdatos1.fun_Buscar_CODIGO_MANT_CARAPRED(Val(txtCAPRCODI.Text))

            If tbl_Consulta1.Rows.Count > 0 Then
                Dim inConsulta As Integer = Trim(tbl_Consulta1.Rows(0).Item(0))

                Dim frm_consulta_CARAPRED As New frm_CARAPRED(Val(inConsulta))
                txtCAPRCODI.Focus()
                Me.Close()
            Else
