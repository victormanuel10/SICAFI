...
Public Class frm_insertar_DESTINACION

    '============================
    '*** INSERTAR DESTINACION ***
    '============================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        pp_pro_LimpiarCampos(fraDESTINACION)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_DESTINACION(Me.txtDESTCODI)
            ...
            If boLLAVEPRIMARIA = True And _
               boDESTCODI = True And _
               boDESTDESC = True And _
               boDESTESTA = True Then

                Dim objdatos22 As New cla_DESTINACION

                If (objdatos22.fun_Insertar_MANT_DESTINACION(Me.txtDESTCODI.Text, _
