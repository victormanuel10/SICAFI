...
Public Class frm_insertar_CLASSUEL

    '===============================
    '*** INSERTAR CLASE DE SUELO ***
    '===============================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        pp_pro_LimpiarCampos(fraCLASSUEL)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_CLASSUEL(Me.txtCLSUCODI)

            Dim objVerifica As New cla_Verificar_Dato

            Dim boCLSUCODI As Boolean = objVerifica.fun_Verificar_Dato_Vacio_Y_Numerico(Me.txtCLSUCODI)
            Dim boCLSUDESC As Boolean = objVerifica.fun_Verificar_Dato_Lleno(Me.txtCLSUDESC)
            Dim boCLSUESTA As Boolean = objVerifica.fun_Verificar_Dato_Lleno(Me.cboCLSUESTA)

            ' verifica los datos del formulario 
            If boLLAVEPRIMARIA = True And _
               boCLSUCODI = True And _
               boCLSUDESC = True And _
               boCLSUESTA = True Then

                Dim objdatos22 As New cla_CLASSUEL

                If (objdatos22.fun_Insertar_MANT_CLASSUEL(Me.txtCLSUCODI.Text, _
...
#Region "KeyDown"
    ...
    Private Sub cboCLSUESTA_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboCLSUESTA.KeyDown
