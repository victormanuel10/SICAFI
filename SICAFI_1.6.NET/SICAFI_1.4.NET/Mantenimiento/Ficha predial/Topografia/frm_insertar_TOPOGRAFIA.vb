...
Public Class frm_insertar_TOPOGRAFIA
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        pp_pro_LimpiarCampos(fraTOPOGRAFIA)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_TOPOGRAFIA(Me.txtTOPOCODI)
            ...
            If boLLAVEPRIMARIA = True And _
               boTOPOCODI = True And _
               boTOPODESC = True And _
               boTOPOESTA = True Then

                Dim objdatos22 As New cla_TOPOGRAFIA

                If (objdatos22.fun_Insertar_MANT_TOPOGRAFIA(Me.txtTOPOCODI.Text, _
