...
Public Class frm_consultar_CLASSECT

    '===============================
    '*** CONSULTA CLASE O SECTOR ***
    '===============================
...
#Region "MENU"
    ...
    Private Sub cmdCONSULTAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCONSULTAR.Click
        Try
            ...
            tbl_Consulta1 = objdatos1.fun_Buscar_CODIGO_MANT_CLASSECT(Val(txtCLSECODI.Text))

            If tbl_Consulta1.Rows.Count > 0 Then
                Dim inConsulta As Integer = Trim(tbl_Consulta1.Rows(0).Item(0))

                Dim frm_consulta_CLASSECT As New frm_CLASSECT(Val(inConsulta))
                txtCLSECODI.Focus()
                Me.Close()
            Else
...
#Region "FORMULARIO"
    ...
    Private Sub txtCLASSECT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtCLSECODI.KeyPress
    ...
    Private Sub txtCLASSECT_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCLSECODI.GotFocus
