...
Public Class frm_insertar_AREAACTI

    '===================================
    '*** INSERTAR AREAS DE ACTIVIDAD ***
    '===================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        pp_pro_LimpiarCampos(fraAREAACTI)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_AREAACTI(Me.txtARACCODI)
            ...
            If boLLAVEPRIMARIA = True And _
               boARACCODI = True And _
               boARACDESC = True And _
               boARACESTA = True Then

                Dim objdatos22 As New cla_AREAACTI

                If (objdatos22.fun_Insertar_MANT_AREAACTI(Me.txtARACCODI.Text, _
