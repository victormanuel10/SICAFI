...
Public Class frm_consultar_CATESUEL

    '===================================
    '*** CONSULTA CATEGORIA DE SUELO ***
    '===================================
...
#Region "MENU"
    ...
    Private Sub cmdCONSULTAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCONSULTAR.Click
        Try
            ...
            tbl_Consulta1 = objdatos1.fun_Buscar_CODIGO_MANT_CATESUEL(Val(txtCASUCODI.Text))

            If tbl_Consulta1.Rows.Count > 0 Then
                Dim inConsulta As Integer = Trim(tbl_Consulta1.Rows(0).Item(0))

                Dim frm_consulta_CATESUEL As New frm_CATESUEL(Val(inConsulta))
                txtCASUCODI.Focus()
                Me.Close()
            Else
...
#Region "FORMULARIO"
    ...
    Private Sub txtCAPRCODI_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtCASUCODI.KeyPress
    ...
    Private Sub txtCAPRCODI_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCASUCODI.GotFocus
