...
Public Class frm_insertar_CAUSACTO

    '===============================
    '*** INSERTAR CAUSA DEL ACTO ***
    '===============================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        pp_pro_LimpiarCampos(fraCAUSACTO)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_CAUSACTO(Me.txtCAACCODI)
            ...
            If boLLAVEPRIMARIA = True And boCAACCODI = True And boCAACDESC = True And boCAACESTA = True Then

                Dim objdatos22 As New cla_CAUSACTO

                If (objdatos22.fun_Insertar_MANT_CAUSACTO(Me.txtCAACCODI.Text, _
