...
Public Class frm_modificar_TIPOTRAM

    '=================================
    '*** MODIFICAR TIPO DE TRAMITE ***
    '=================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Me.cboTITRESTA.DataSource = objdatos.fun_Consultar_TODOS_LOS_ESTADOS
        Me.cboTITRESTA.DisplayMember = "ESTADESC"
        Me.cboTITRESTA.ValueMember = "ESTACODI"

        Dim objdatos1 As New cla_TIPOTRAM
        Dim tbl As New DataTable

        tbl = objdatos1.fun_Buscar_ID_MANT_TIPOTRAM(inID_REGISTRO)

        Me.txtTITRCODI.Text = Trim(tbl.Rows(0).Item("TITRCODI").ToString)
        Me.txtTITRDESC.Text = Trim(tbl.Rows(0).Item("TITRDESC").ToString)
        Me.cboTITRESTA.SelectedValue = tbl.Rows(0).Item("TITRESTA").ToString
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        Try
            ...
            If boTITRCODI = True And boTITRDESC = True And boTITRESTA = True Then
                ...
                If objdatos.fun_Actualizar_MANT_TIPOTRAM(inID_REGISTRO, Me.txtTITRCODI.Text, Me.txtTITRDESC.Text, Me.cboTITRESTA.SelectedValue) = True Then
                    Me.txtTITRDESC.Focus()
                    Me.Close()
