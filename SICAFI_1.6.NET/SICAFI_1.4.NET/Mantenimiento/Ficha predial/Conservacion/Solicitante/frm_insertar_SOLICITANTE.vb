...
Public Class frm_insertar_SOLICITANTE
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        pp_pro_LimpiarCampos(fraSOLICITANTE)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_SOLICITANTE(Me.txtSOLICODI)
            ...
            If boLLAVEPRIMARIA = True And boTITRCODI = True And boTITRDESC = True And boTITRESTA = True Then
                ...
                Dim objdatos22 As New cla_SOLICITANTE

                If (objdatos22.fun_Insertar_MANT_SOLICITANTE(Me.txtSOLICODI.Text, Me.txtSOLIDESC.Text, Me.cboSOLIESTA.SelectedValue)) Then
