...
Public Class frm_insertar_TIPOVARI

    '=================================
    '*** INSERTAR TIPO DE VARIABLE ***
    '=================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        pp_pro_LimpiarCampos(fraTIPOVARI)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_TIPOVARI(Me.txtTIVACODI)

            Dim objVerifica As New cla_Verificar_Dato

            Dim boTIVACODI As Boolean = objVerifica.fun_Verificar_Dato_Vacio_Y_Numerico(Me.txtTIVACODI)
            Dim boTIVADESC As Boolean = objVerifica.fun_Verificar_Dato_Lleno(Me.txtTIVADESC)
            Dim boTIVAESTA As Boolean = objVerifica.fun_Verificar_Dato_Lleno(Me.cboTIVAESTA)

            ' verifica los datos del formulario 
            If boLLAVEPRIMARIA = True And boTIVACODI = True And boTIVADESC = True And boTIVAESTA = True Then

                Dim objdatos22 As New cla_TIPOVARI

                If (objdatos22.fun_Insertar_MANT_TIPOVARI(Me.txtTIVACODI.Text, Me.txtTIVADESC.Text, Me.cboTIVAESTA.SelectedValue)) Then
...
#Region "KeyDown"
    ...
    Private Sub cboTIVAESTA_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboTIVAESTA.KeyDown
