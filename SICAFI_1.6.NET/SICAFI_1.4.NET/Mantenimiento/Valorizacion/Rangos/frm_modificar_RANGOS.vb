...
Public Class frm_modificar_RANGOS
...
#Region "CONSTRUCTOR"
    ...
    Public Sub New(ByVal inInRegistroFactores As Integer, ByVal inInRegistroRangos As Integer)

        inID_REGISTRO = inInRegistroFactores
        inID_RANGOS = inInRegistroRangos
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            ...
            Dim objdatos111 As New cla_RANGOS
            Dim tbl111 As New DataTable

            tbl111 = objdatos111.fun_Buscar_ID_MANT_RANGOS(inID_RANGOS)

            Me.txtRANGRAIN.Text = Trim(tbl111.Rows(0).Item("RANGRAIN"))
            Me.txtRANGRAFI.Text = Trim(tbl111.Rows(0).Item("RANGRAFI"))
            Me.txtRANGFAIN.Text = Trim(tbl111.Rows(0).Item("RANGFAIN"))
            Me.txtRANGFAFI.Text = Trim(tbl111.Rows(0).Item("RANGFAFI"))
            Me.txtRANGFAAP.Text = Trim(tbl111.Rows(0).Item("RANGFAAP"))
            ...
            Me.cboRANGESTA.SelectedValue = tbl111.Rows(0).Item("RANGESTA")
        ...
        Try
            ...
            If boFACTDEPA = True And _
               ...
               boCONCESTA = True Then
                ...
                If objdatos.fun_Actualizar_MANT_RANGOS(inID_RANGOS, _
                                                     Me.cboRANGDEPA.SelectedValue, _
