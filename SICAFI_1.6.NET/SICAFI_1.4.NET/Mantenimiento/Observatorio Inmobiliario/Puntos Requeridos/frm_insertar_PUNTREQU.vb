...
Public Class frm_insertar_PUNTREQU

    '==================================
    '*** INSERTAR PUNTOS REQUERIDOS ***
    '==================================
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_PUNTREQU(Me.cboPUREDEPA, _
                                                                                           Me.cboPUREMUNI, _
                                                                                           Me.cboPURECLSE)
            ' instancia la clase
            ...
            If boLLAVEPRIMARIA = True And _
               ...
               boPUREESTA = True Then
                ...
                If (objdatos22.fun_Insertar_PUNTREQU(Me.cboPUREDEPA.SelectedValue, _
...
#Region "Validated"
    ...
    Private Sub txtTAAPAVFI_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPUREPURE.Validated
