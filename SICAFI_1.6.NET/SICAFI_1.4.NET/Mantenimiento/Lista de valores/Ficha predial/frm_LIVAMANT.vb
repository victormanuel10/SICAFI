...
#Region "PASO 1 VERIFICAR TABLAS"
    ...
    Private Sub pro_VerificarTablas()
        ...
        Dim objdatos15 As New cla_PUNTCARD
        Dim tbl15 As New DataTable
        tbl15 = objdatos15.fun_Consultar_MANT_PUNTCARD

        If tbl15.Rows.Count > 0 Then
            chkPUNTCARD.Checked = True
            chkACTUPUNTCARD.Checked = True
            chkACTUPUNTCARD.Enabled = False
            lblACTUPUNTCARD.Text = "Actualizado"
        Else
            chkPUNTCARD.Checked = False
        End If
...
#Region "PASO 2 ACTUALIZAR CAMPOS"
    ...
    Private Sub pro_ActualizarCampos()
        ...
        Try
            ...
            If chkPUNTCARD.Checked = False Then
                If chkACTUPUNTCARD.Checked = True Then
                    Dim objdatos As New cla_LIVAMANT

                    If (objdatos.fun_Actualizar_ListaDeValores_MANT_PUNTCARD) Then

                        lblACTUPUNTCARD.Text = "Actualizado"
                        chkPUNTCARD.Checked = True
                        chkACTUPUNTCARD.Enabled = False
                    Else
                        lblACTUPUNTCARD.Text = "No actualizado"
                        chkACTUPUNTCARD.Checked = False
                    End If
...
#Region "PASO 3 ACTIVAR BOTON INSERTAR"
    ...
    Private Sub pro_ActivarBotonInsertarDatos()
        ...
        chkACTUPUNTCARD.Enabled = True And chkACTUPUNTCARD.Checked = True Or _
...
#Region "PASO 4 ACTUALIZAR TODOS LOS CheckBox"
    ...
    Private Sub chkActualizarTodas_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkActualizarTodas.CheckedChanged
        ...
        If chkActualizarTodas.Checked = True Then
            ...
            If chkACTUPUNTCARD.Checked = False Then
                chkACTUPUNTCARD.Checked = True
            End If
        ...
        Else
            ...
            If chkACTUPUNTCARD.Enabled = True Then
                chkACTUPUNTCARD.Checked = False
            End If
...
#Region "FORMULARIO"
    ...
    Private Sub chkACTUTIPOCALI_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkACTUTIPOCALI.CheckedChanged
        pro_ActivarBotonInsertarDatos()
    End Sub
    Private Sub cmdVERTABLAS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdVERTABLAS.Click
        frm_LISTVALOMANT.ShowDialog()
    End Sub
