...
Public Class frm_insertar_SERVPUBL
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_SERVPUBL(Me.txtSEPUCODI)
            ...
            If boLLAVEPRIMARIA = True And boSEPUCODI = True And boSEPUDESC = True And boSEPUESTA = True Then

                Dim objdatos22 As New cla_SERVPUBL

                If (objdatos22.fun_Insertar_MANT_SERVPUBL(Me.txtSEPUCODI.Text, Me.txtSEPUDESC.Text, Me.cboSEPUESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_SERVPUBL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
