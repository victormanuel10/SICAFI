...
Public Class frm_insertar_UBICVIVI

    '======================================
    '*** INSERTAR UBICACION DE VIVIENDA ***
    '======================================
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_UBICVIVI(Me.txtUBVICODI)
            ...
            If boLLAVEPRIMARIA = True And boUBVICODI = True And boUBVIDESC = True And boUBVIESTA = True Then

                Dim objdatos22 As New cla_UBICVIVI

                If (objdatos22.fun_Insertar_MANT_UBICVIVI(Me.txtUBVICODI.Text, Me.txtUBVIDESC.Text, Me.cboUBVIESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_UBICVIVI_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
