...
Public Class frm_modificar_RUTAPLMA

    '======================================
    '*** MODIFICAR RUTA PLANO MANZANERO ***
    '======================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            ...
            Dim objdatos8 As New cla_RUTAPLMA
            Dim tbl As New DataTable

            tbl = objdatos8.fun_Buscar_ID_MANT_RUTAPLMA(inID_REGISTRO)

            Dim objdatos11 As New cla_DEPARTAMENTO

            Me.cboRUPMDEPA.DataSource = objdatos11.fun_Consultar_CAMPOS_MANT_DEPARTAMENTO
            Me.cboRUPMDEPA.DisplayMember = "DEPADESC"
            Me.cboRUPMDEPA.ValueMember = "DEPACODI"

            Me.cboRUPMDEPA.SelectedValue = tbl.Rows(0).Item("RUPMDEPA")

            Dim objdatos12 As New cla_MUNICIPIO

            Me.cboRUPMMUNI.DataSource = objdatos12.fun_Consultar_CAMPOS_MANT_MUNICIPIO
            Me.cboRUPMMUNI.DisplayMember = "MUNIDESC"
            Me.cboRUPMMUNI.ValueMember = "MUNICODI"

            Me.cboRUPMMUNI.SelectedValue = tbl.Rows(0).Item("RUPMMUNI")

            Dim objdatos1 As New cla_CLASSECT

            Me.cboRUPMCLSE.DataSource = objdatos1.fun_Consultar_CAMPOS_MANT_CLASSECT
            Me.cboRUPMCLSE.DisplayMember = "CLSEDESC"
            Me.cboRUPMCLSE.ValueMember = "CLSECODI"

            Me.cboRUPMCLSE.SelectedValue = tbl.Rows(0).Item("RUPMCLSE")

            Dim objdatos18 As New cla_CORREGIMIENTO

            Me.cboRUPMCORR.DataSource = objdatos18.fun_Consultar_CAMPOS_CORREGIMIENTO
            Me.cboRUPMCORR.DisplayMember = "CORRDESC"
            Me.cboRUPMCORR.ValueMember = "CORRCODI"

            Me.cboRUPMCORR.SelectedValue = tbl.Rows(0).Item("RUPMCORR")

            Dim objdatos19 As New cla_BARRVERE

            Me.cboRUPMBAVE.DataSource = objdatos19.fun_Consultar_CAMPOS_BARRVERE
            Me.cboRUPMBAVE.DisplayMember = "BAVEDESC"
            Me.cboRUPMBAVE.ValueMember = "BAVECODI"

            Me.cboRUPMBAVE.SelectedValue = tbl.Rows(0).Item("RUPMBAVE")

            Me.txtRUPMRUTA.Text = Trim(tbl.Rows(0).Item("RUPMRUTA"))

            Dim objdatos16 As New cla_ESTADO

            Me.cboRUPMESTA.DataSource = objdatos16.fun_Consultar_TODOS_LOS_ESTADOS
            Me.cboRUPMESTA.DisplayMember = "ESTADESC"
            Me.cboRUPMESTA.ValueMember = "ESTACODI"

            Me.cboRUPMESTA.SelectedValue = tbl.Rows(0).Item("RUPMESTA")
            ...
            If CInt(Me.lblRUPMCLSE.Text) = 1 Or CInt(Me.lblRUPMCLSE.Text) = 3 Then
                Me.lblRUPMBAVE.Text = CType(fun_Buscar_Lista_Valores_BARRVERE_Codigo(Me.cboRUPMDEPA, Me.cboRUPMMUNI, Me.cboRUPMCLSE, Me.cboRUPMBAVE, Me.cboRUPMCORR), String)
            ElseIf CInt(Me.lblRUPMCLSE.Text) = 2 Then
                Me.lblRUPMBAVE.Text = CType(fun_Buscar_Lista_Valores_BARRVERE_Codigo(Me.cboRUPMDEPA, Me.cboRUPMMUNI, Me.cboRUPMCLSE, Me.cboRUPMBAVE, Me.cboRUPMCORR), String)
            End If
        ...
        Try
            ...
            If boOBINDEPA = True And _
               ...
               boRUTARUTA = True Then
                ...
                If (objdatos22.fun_Actualizar_MANT_RUTAPLMA(inID_REGISTRO, _
                                                            Me.cboRUPMDEPA.SelectedValue, _
