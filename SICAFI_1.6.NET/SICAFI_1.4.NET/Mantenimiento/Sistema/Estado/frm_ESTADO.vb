...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_ESTADO
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_ESTADO
        End If
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_Reconsultar()
        ...
        Try
            ...
            Me.BindingSource_ESTADO_1.DataSource = objdatos.fun_Consultar_ESTADO
            Me.dgvESTAESTA.DataSource = BindingSource_ESTADO_1
            Me.BindingNavigator_ESTADO_1.BindingSource = BindingSource_ESTADO_1

            Me.strBARRESTA.Items(2).Text = "Registros : " & BindingSource_ESTADO_1.Count
            Me.dgvESTAESTA.Columns(0).Visible = False

            Dim ContarRegistros As Integer = BindingSource_ESTADO_1.Count

            Me.dgvESTAESTA.Columns(1).Width = 100
            Me.dgvESTAESTA.Columns(2).Width = 200
            Me.dgvESTAESTA.Columns(3).Width = 100
    ...
    Private Sub cmdELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdELIMINAR.Click
        Try
            ...
            If MessageBox.Show("¿ Desea eliminar el registro seleccionado ? " & Chr(Keys.Enter) & Chr(Keys.Enter) & "Nro código : " & Codigo, "Mensaje...", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                ...
                If objdatos.fun_Eliminar_ESTADO(Integer.Parse(dgvESTAESTA.CurrentRow.Cells(0).Value.ToString())) Then
                    pro_Reconsultar()
                Else
