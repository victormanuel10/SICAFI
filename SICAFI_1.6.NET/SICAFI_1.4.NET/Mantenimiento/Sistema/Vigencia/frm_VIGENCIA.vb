...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_Reconsultar()
        ...
        BindingSource_VIGENCIA_1.DataSource = objdatos.fun_Consultar_VIGENCIA
        dgvVIGENCIA.DataSource = BindingSource_VIGENCIA_1
        BindingNavigator_VIGENCIA_1.BindingSource = BindingSource_VIGENCIA_1

        strBARRESTA.Items(2).Text = "Registros: " & BindingSource_VIGENCIA_1.Count
            ...
            If MessageBox.Show("¿ Desea eliminar el registro seleccionado ? " & Chr(Keys.Enter) & Chr(Keys.Enter) & "Nro código : " & Codigo, "Mansaje", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                ...
                If Trim(contrasena) <> "" Then
                    If contrasena = ClaveEliminar Then
                        ...
                        objdatos.fun_Eliminar_VIGENCIA(Integer.Parse(dgvVIGENCIA.CurrentRow.Cells(0).Value.ToString()))
                        pro_Reconsultar()
                    Else
...
#Region "FORMULARIO"
    ...
    Private Sub dgvVIGENCIA_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvVIGENCIA.LostFocus
