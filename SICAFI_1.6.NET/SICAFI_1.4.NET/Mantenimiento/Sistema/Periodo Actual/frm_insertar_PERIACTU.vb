...
Public Class frm_insertar_PERIACTU

    '===============================
    '*** INSERTAR PERIODO ACTUAL ***
    '===============================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        pp_pro_LimpiarCampos(fraPERIACTU)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_MANT_PERIACTU(Me.txtPEACCODI)

            Dim objVerifica As New cla_Verificar_Dato

            Dim boTIAFCODI As Boolean = objVerifica.fun_Verificar_Dato_Vacio_Y_Numerico(Me.txtPEACCODI)
            Dim boTIAFDESC As Boolean = objVerifica.fun_Verificar_Dato_Lleno(Me.txtPEACDESC)
            Dim boTIAFESTA As Boolean = objVerifica.fun_Verificar_Dato_Lleno(Me.cboPEACESTA)
            ...
            If boLLAVEPRIMARIA = True And boTIAFCODI = True And boTIAFDESC = True And boTIAFESTA = True Then
                ...
                If (objdatos22.fun_Insertar_MANT_PERIACTU(Me.txtPEACCODI.Text, Me.txtPEACDESC.Text, Me.chkPEACPEAC.Checked, Me.cboPEACESTA.SelectedValue)) Then
...
#Region "Load"
    ...
    Private Sub frm_insertar_PERIACTU_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        pro_LimpiarCampos()
    End Sub
...
#Region "Validated"
    ...
    Private Sub txtCAPRCODI_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPEACCODI.Validated

        If fun_Verificar_Campos_Llenos_1_DATOS(Me.txtPEACCODI.Text) = True Then

            Dim obVerifica As New cla_Verificar_Dato
            If obVerifica.fun_Verificar_Dato_Vacio_Y_Numerico(Me.txtPEACCODI) = True Then

                Dim obDatos As New cla_PERIACTU
                obDatos.fun_Verifica_llave_Primaria_MANT_PERIACTU(Me.txtPEACCODI)
            End If
