...
Public Class frm_insertar_FORMULA
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_LimpiarCampos()
        ...
        pp_pro_LimpiarCampos(fraFORMULA)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_FORMULA(Me.txtFORMCODI)
            ...
            If boLLAVEPRIMARIA = True And boFORMCODI = True And boFORMDESC = True And boFORMESTA = True Then

                Dim objdatos22 As New cla_FORMULA

                If (objdatos22.fun_Insertar_FORMULA(Me.txtFORMCODI.Text, Me.txtFORMDESC.Text, Me.cboFORMESTA.SelectedValue)) Then
