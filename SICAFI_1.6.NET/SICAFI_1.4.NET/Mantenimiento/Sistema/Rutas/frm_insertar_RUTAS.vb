...
Public Class frm_insertar_RUTAS
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim boLLAVEPRIMARIA As Boolean = objdatos.fun_Verifica_llave_Primaria_RUTAS(Me.txtRUTACODI)
            ...
            If boLLAVEPRIMARIA = True And _
               boRUTACODI = True And _
               boRUTADESC = True And _
               boRUTARUTA = True And _
               boRUTAESTA = True Then

                Dim objdatos22 As New cla_RUTAS

                If (objdatos22.fun_Insertar_MANT_RUTAS(Me.txtRUTACODI.Text, Me.txtRUTADESC.Text, Me.txtRUTARUTA.Text, Me.cboRUTAESTA.SelectedValue)) Then
...
#Region "KeyDown"
    ...
    Private Sub cboTIAFESTA_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cboRUTAESTA.KeyDown
