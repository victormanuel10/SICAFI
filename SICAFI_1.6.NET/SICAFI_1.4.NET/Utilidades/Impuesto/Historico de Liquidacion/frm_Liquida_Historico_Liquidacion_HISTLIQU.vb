...
Public Class frm_Liquida_Historico_Liquidacion_HISTLIQU

    '============================================================
    '*** LIQUIDAR HISTORICO DE LIQUIDACIÓN SUJETO DE IMPUESTO ***
    '============================================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_Liquida_Historico_Liquidacion_HISTLIQU
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_Liquida_Historico_Liquidacion_HISTLIQU
        End If
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If MessageBox.Show("Se registraron: " & dt.Rows.Count & " predios. " & " ¿ Desea continuar ? ", "Mensaje ...", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        For i = 0 To dt.Rows.Count - 1
                            ...
                            tbl66 = objdatos66.fun_Buscar_CODIGO_DEPA_MUNI_CLSE_VIGE_X_PEPELIQU(stFIPRDEPA, stFIPRMUNI, inFIPRCLSE, inFIPRVIGE)
                        ...
                        MessageBox.Show("Proceso de historico de liquidación terminado", "Mensaje ...", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
