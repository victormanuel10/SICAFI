...
Public Class frm_Historico_Sujeto_Impuesto

    '================================================
    '*** LIQUIDAR HISTORICO DE SUJETO DE IMPUESTO ***
    '================================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_Historico_Sujeto_Impuesto
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_Historico_Sujeto_Impuesto
        End If
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If MessageBox.Show("Se registraron: " & dt.Rows.Count & " predios. " & " ¿ Desea continuar ? ", "Mensaje ...", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        For i = 0 To dt.Rows.Count - 1
                            ...
                            Dim inFIPRVIGE As Integer = CInt(dt.Rows(i).Item("FIPRVIGE"))
                            ...
                            tbl66 = objdatos66.fun_Buscar_CODIGO_DEPA_MUNI_CLSE_VIGE_X_PEPELIQU(stFIPRDEPA, stFIPRMUNI, CInt(Me.cboFIPRCLSE.SelectedValue), CInt(Me.cboFIPRVIGE.SelectedValue))
                            ...
                            If tbl66.Rows.Count = 0 OrElse CBool(tbl66.Rows(0).Item("PPLIHIAV")) = False Then
                                ...
                                End If
                            Else
                                pro_GENERA_HISTORICO_DE_SUJETO_DE_IMPUESTO(inFIPRNUFI, inFIPRCLSE, Me.cboFIPRVIGE.SelectedValue, Me.rbdSUIMVIAC.Checked, Me.rbdSUIMVIAN.Checked, Me.rbdRemplazarTodosLosPredios.Checked, Me.rbdInscribirSoloPrediosNuevos.Checked)

                                If Me.chkHistoricoZonas.Checked = True Then
                                    pro_GENERA_HISTORICO_DE_ZONAS_IMPUESTO(inFIPRNUFI, stFIPRDEPA, stFIPRMUNI, stFIPRCORR, stFIPRBARR, stFIPRMANZ, stFIPRPRED, stFIPREDIF, stFIPRUNPR, inFIPRCLSE, Me.cboFIPRVIGE.SelectedValue, inFIPRTIFI, Me.rbdZonaEconomica.Checked, Me.rbdZonaFisica.Checked)
                                End If

                                If Me.chkHistoricoAvaluo.Checked = True Then
                                    pro_LIQUIDA_HISTORICO_DE_AVALUO_IMPUESTO(inFIPRNUFI, Me.cboFIPRVIGE.SelectedValue, Me.chkLiquidaIncrementoZona.Checked, Me.chkLiquidaIncrementoIdentificador.Checked)
                                End If

                                If Me.chkHistoricoLiquidacion.Checked = True Then
                                    pro_GENERA_HISTORICO_DE_LIQUIDACION_IMPUESTO(inFIPRNUFI, Me.cboFIPRVIGE.SelectedValue)
                                End If

                                If Me.chkAforoImpuesto.Checked = True Then
                                    pro_LIQUIDA_AFORO_IMPUESTO(inFIPRNUFI, Me.cboFIPRVIGE.SelectedValue, Me.cboFIPRCLSE.SelectedValue, Me.cboAFSITIIM.SelectedValue, Me.cboAFSICONC.SelectedValue, Me.chkAplicarPorcentajeMaximoDeLiquidacion.Checked, Me.rbdAplicarTarifaUnicaAlLote.Checked, Me.rbdAplicarTarifaPorZonaAlLote.Checked)
                                End If
                        ...
                        MessageBox.Show("Proceso de historico de sujeto de impuesto terminado", "Mensaje ...", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
...
#Region "CheckedChanged"
    ...
    Private Sub chkHistoricoZonas_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkHistoricoZonas.CheckedChanged

        If Me.chkHistoricoZonas.Checked = True Then
            Me.chkHistoricoAvaluo.Visible = True
        Else
            Me.chkHistoricoAvaluo.Checked = False
            Me.chkHistoricoLiquidacion.Checked = False
            Me.chkAforoImpuesto.Checked = False
            Me.chkLiquidaIncrementoZona.Checked = False
            Me.chkLiquidaIncrementoIdentificador.Checked = False

            Me.chkHistoricoAvaluo.Visible = False
    ...
    End Sub
    Private Sub chkHistoricoAvaluo_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkHistoricoAvaluo.CheckedChanged

        If Me.chkHistoricoAvaluo.Checked = True Then
            Me.chkHistoricoLiquidacion.Visible = True
            Me.chkLiquidaIncrementoZona.Visible = True
            Me.chkLiquidaIncrementoIdentificador.Visible = True
        Else
            Me.chkHistoricoLiquidacion.Checked = False
            Me.chkAforoImpuesto.Checked = False
            Me.chkLiquidaIncrementoZona.Checked = False
    ...
    End Sub
    Private Sub chkHistoricoLiquidacion_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkHistoricoLiquidacion.CheckedChanged

        If Me.chkHistoricoLiquidacion.Checked = True Then
            Me.chkAforoImpuesto.Visible = True
        Else
            Me.chkAforoImpuesto.Checked = False
            Me.chkAforoImpuesto.Visible = False
        End If
    ...
    End Sub
    Private Sub chkAforoImpuesto_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkAforoImpuesto.CheckedChanged

        If Me.chkAforoImpuesto.Checked = True Then
            Me.cboAFSITIIM.Enabled = True
            Me.cboAFSICONC.Enabled = True
        Else
