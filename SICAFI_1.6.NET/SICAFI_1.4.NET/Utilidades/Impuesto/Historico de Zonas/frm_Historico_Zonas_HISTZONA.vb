...
Public Class frm_Historico_Zonas_HISTZONA

    '======================================================
    '*** LIQUIDAR HISTORICO DE ZONAS SUJETO DE IMPUESTO ***
    '======================================================
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_Historico_Zonas_HISTZONA
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_Historico_Zonas_HISTZONA
        End If
    ...
    Private Sub cmdLIQUIDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLIQUIDAR.Click
        ...
        Try
            ...
            Else
                ...
                ParametrosConsulta += "FiprTifi in ('0','1','2') " & " and "
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If MessageBox.Show("Se registraron: " & dt.Rows.Count & " predios. " & " ¿ Desea continuar ? ", "Mensaje ...", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                        ...
                        MessageBox.Show("Proceso de historico de zonas terminado", "Mensaje ...", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
