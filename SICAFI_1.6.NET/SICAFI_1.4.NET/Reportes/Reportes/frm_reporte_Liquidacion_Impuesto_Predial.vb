...
Public Class frm_reporte_Liquidacion_Impuesto_Predial
...
#Region "INSTANCIAR FORMULARIO"
    ...
    Public Shared Function instance() As frm_reporte_Liquidacion_Impuesto_Predial
        If frm_Instance Is Nothing OrElse frm_Instance.isdisposed = True Then
            frm_Instance = New frm_reporte_Liquidacion_Impuesto_Predial
        End If
    ...
    Private Sub cmdVALIDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdLIQUIDAR.Click
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                dt1.Columns.Add(New DataColumn("Valor impuesto predial", GetType(String)))
                ...
                For i = 0 To dt.Rows.Count - 1
                    ...
                    pro_LIQUIDA_PREDIAL_FICHA_PREDIAL(inFicha, inResolucion, inVigencia, inDocumento)

                    ' consulta las inconsistencas de las fichas validadas
                    Dim objdatos As New cla_PREDIAL
                    Dim tbl As New DataTable

                    tbl = objdatos.fun_Consultar_PREDIAL_X_FICHA_PREDIAL(inFicha)
                    ...
                    If tbl.Rows.Count > 0 Then
                        ...
                        dr1 = dt1.NewRow()
                        dr1("Nro_Ficha") = tbl.Rows(0).Item("PREDNUFI")
                        ...
                        dr1("Valor impuesto predial") = tbl.Rows(0).Item("PREDPRED")
                ...
                If Me.dgvFIPRINCO.RowCount > 0 Then
                    MessageBox.Show("Proceso de liquidación del predial terminado", "Mensaje ...", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
