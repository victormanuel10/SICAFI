...
Public Class frm_insertar_RECLMAEN

    '============================================
    '*** INSERTAR MATERIAL ENTREGADO RECLAMOS ***
    '============================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            ...
            Dim objdatos9 As New cla_RECLMAEN
            Dim tbl9 As New DataTable

            tbl9 = objdatos9.fun_Buscar_ID_X_CONSULTA_PARAMETRIZADA_RECLMAEN(inID_REGISTRO)

            If tbl9.Rows.Count > 0 Then

                Me.txtREMEFECH.Text = Trim(tbl9.Rows(0).Item("REMEFECH"))

                If fun_Verificar_Dato_Fecha_Evento_Validated(Me.txtREMEFECH.Text) = True Then
                    Me.DateTimePicker1.Value = CDate(tbl9.Rows(0).Item("REMEFECH"))
                End If
                ...
                For i = 0 To tbl9.Rows.Count - 1
                    ...
                    dr1("Código") = Trim(tbl9.Rows(i).Item("REMEMACA").ToString)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim obRECLOBME As New cla_RECLOBME
            Dim dtRECLOBME As New DataTable

            dtRECLOBME = obRECLOBME.fun_Buscar_CODIGO_X_RECLOBME(inID_REGISTRO)

            If dtRECLOBME.Rows.Count = 0 Then
                obRECLOBME.fun_Insertar_RECLOBME(inID_REGISTRO, " Nota ingresada por: " & vp_usuario & " " & fun_fecha() & " : " & Trim(Me.txtMAUSOBSE.Text) & ". ")
            Else

                Dim stMAUSOBSE_NUEVA As String = Trim(Me.txtMAUSOBSE.Text)
                ...
                obRECLOBME.fun_Actualizar_RECLOBME(inID_REGISTRO, Trim(stMAUSOBSE_ANTERIOR))
            End If

            If Me.dgvMATEENTR.RowCount = 0 Then
                Dim objdatos15 As New cla_RECLMAEN
                objdatos15.fun_Eliminar_SECU_RECLMAEN(inID_REGISTRO)
            ...
            Else
                ...
                Dim objdatos11 As New cla_RECLMAEN
                objdatos11.fun_Eliminar_SECU_RECLMAEN(inID_REGISTRO)

                Dim tbl As New DataTable
                tbl = Me.dgvMATEENTR.DataSource

                Dim obj_RECLMAFA As New cla_RECLMAFA
                Dim dt_RECLMAFA As New DataTable

                dt_RECLMAFA = obj_RECLMAFA.fun_Buscar_ID_X_CONSULTA_PARAMETRIZADA_RECLMAFA(inID_REGISTRO)
                ...
                For i = 0 To tbl.Rows.Count - 1
                    ...
                    While j1 < dt_RECLMAFA.Rows.Count And sw1 = 0
                        If tbl.Rows(i).Item("Código") = dt_RECLMAFA.Rows(j1).Item("REMFMACA") Then
                            sw1 = 1

                            Dim objEliminaMaterialFaltante As New cla_RECLMAFA
                            objEliminaMaterialFaltante.fun_Eliminar_SECU_X_MACA_RECLMAFA(inID_REGISTRO, dt_RECLMAFA.Rows(j1).Item("REMFMACA"))
                        Else
                            j1 = j1 + 1
                        End If
                    End While

                    Dim objdatos12 As New cla_RECLMAEN
                    objdatos12.fun_Insertar_RECLMAEN(inID_REGISTRO, stCODIGO, Me.txtREMEFECH.Text, Me.txtMAUSOBSE.Text)
...
#Region "GotFocus"
    ...
    Private Sub txt_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMAUSOBSE.GotFocus, txtREMEFECH.GotFocus
...
#Region "ValueChanged"
    ...
    Private Sub DateTimePicker1_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DateTimePicker1.ValueChanged
        Me.txtREMEFECH.Text = Me.DateTimePicker1.Value
    End Sub
