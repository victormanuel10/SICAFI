...
Public Class frm_insertar_archivo_MOVIALFA

    '=================================================
    '*** INSERTAR ARCHIVO MOVIMIENTO ALFANUMERICOS ***
    '=================================================
...
#Region "CONSTRUCTOR"
    ...
    Public Sub New(ByVal stFIPRMUNI As String, _
    ...
    Private Function fun_consultarRutaDestino() As String
        ...
        Try
            ...
            If tblRutas.Rows.Count > 0 Then
                ...
                stRutaDestino = stRuta & Trim(vl_stFIPRMUNI) & "-" & vl_inFIPRCLSE & "-" & Trim(vl_stFIPRCORR) & "-" & Trim(vl_stFIPRBARR) & "-" & Trim(vl_stFIPRMANZ) & "-" & Trim(vl_stFIPRPRED) & "-" & vl_inFIPRVIGE & "\" & Me.lstLISTADO_DOCUMENTOS.SelectedItem
