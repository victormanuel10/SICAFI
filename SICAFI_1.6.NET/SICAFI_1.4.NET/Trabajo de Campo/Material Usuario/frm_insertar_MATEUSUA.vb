...
Public Class frm_insertar_MATEUSUA

    '====================================
    '*** INSERTAR MATERIAL DE USUARIO ***
    '====================================
...
#Region "PROCEDIMIENTOS"
    ...
    Private Sub pro_inicializarControles()
        ...
        Try
            ...
            Dim objdatos9 As New cla_MATEUSUA
            Dim tbl9 As New DataTable

            tbl9 = objdatos9.fun_Buscar_ID_X_CONSULTA_PARAMETRIZADA_MATEUSUA(inID_REGISTRO)

            If tbl9.Rows.Count > 0 Then

                Me.txtMAUSFECH.Text = Trim(tbl9.Rows(0).Item("MAUSFECH"))
                'Me.txtMAUSOBSE.Text = Trim(tbl9.Rows(0).Item("MAUSOBSE").ToString)
                ...
                For i = 0 To tbl9.Rows.Count - 1
                    ...
                    dr1("Código") = Trim(tbl9.Rows(i).Item("MAUSMACA").ToString)
...
#Region "MENU"
    ...
    Private Sub cmdGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGUARDAR.Click
        ...
        Try
            ...
            Dim obTRCAOBME As New cla_TRCAOBME
            Dim dtTRCAOBME As New DataTable

            dtTRCAOBME = obTRCAOBME.fun_Buscar_CODIGO_X_TRCAOBME(inID_REGISTRO)

            If dtTRCAOBME.Rows.Count = 0 Then
                obTRCAOBME.fun_Insertar_TRCAOBME(inID_REGISTRO, " Nota ingresada por: " & vp_usuario & " " & fun_fecha() & " : " & Trim(Me.txtMAUSOBSE.Text) & ". ")
            Else

                Dim stMAUSOBSE_NUEVA As String = Trim(Me.txtMAUSOBSE.Text)
                Dim stMAUSOBSE_ANTERIOR As String = Trim(dtTRCAOBME.Rows(0).Item("TCMEOBSE"))

                If Trim(stMAUSOBSE_NUEVA) <> "" Then
                    stMAUSOBSE_ANTERIOR += " Nota ingresada por: " & vp_usuario & " " & fun_fecha() & " : " & stMAUSOBSE_NUEVA & ". "
                End If

                obTRCAOBME.fun_Actualizar_TRCAOBME(inID_REGISTRO, Trim(stMAUSOBSE_ANTERIOR))
            End If

            If Me.dgvMATEUSUA.RowCount = 0 Then
                Dim objdatos15 As New cla_MATEUSUA
                objdatos15.fun_Eliminar_SECU_MATEUSUA(inID_REGISTRO)
            ...
            Else
                ...
                Dim objdatos11 As New cla_MATEUSUA
                objdatos11.fun_Eliminar_SECU_MATEUSUA(inID_REGISTRO)
                ...
                For i = 0 To tbl.Rows.Count - 1
                    ...
                    Dim objdatos12 As New cla_MATEUSUA
                    objdatos12.fun_Insertar_MATEUSUA(inID_REGISTRO, stCODIGO, Me.txtMAUSFECH.Text, Me.txtMAUSOBSE.Text)
