...
Public Class cla_TARIRAAR

    '===================================
    '*** CLASE TARIFA RANGO DE AREAS ***
    '===================================

    ''' <summary>
    ''' procedimiento que verifica la llave primaria.
    ''' </summary>
    Public Function fun_Verifica_llave_Primaria_TARIRAAR(ByVal obTARADEPA As Object, _
               ...
               obVerifica.fun_Verificar_Campo_Lleno(obTARAAVFI.Text) = True Then
                ...
                If obVerifica.fun_Verificar_Dato_Numerico(obTARADEPA.SelectedValue) = True And _
                   ...
                   obVerifica.fun_Verificar_Dato_Numerico(obTARAAVFI.Text) = True Then
                    ...
                    Dim objdatos1 As New cla_TARIRAAR
                    Dim tbl As New DataTable

                    tbl = objdatos1.fun_Buscar_CODIGO_DEPA_MUNI_CLSE_VIGE_DEEC_ESTR_AVIN_AVFI_X_TARIRAAR(obTARADEPA.SelectedValue, _
    ...
    ''' </summary>
    Public Function fun_Insertar_TARIRAAR(ByVal stTARADEPA As String, _
        ...
        Catch ex As Exception
            Return False
            MessageBox.Show(Err.Description & " " & "fun_Insertar_TARIRAAR")
        End Try
    ...
    ''' </summary>
    Public Function fun_Eliminar_TARIRAAR(ByVal inTARAIDRE As Integer) As Boolean
        ...
        Catch ex As Exception
            Return False
            MessageBox.Show(Err.Description & " " & "fun_Eliminar_TARIRAAR")
        End Try
    ...
    ''' </summary>
    Public Function fun_Actualizar_TARIRAAR(ByVal inTARAIDRE As Integer, _
        ...
        Catch ex As Exception
            Return False
            MessageBox.Show(Err.Description & " " & "fun_Actualizar_TARIRAAR")
        End Try
    ...
    ''' de la columna. 
    ''' </summary>
    Public Function fun_Consultar_TARIRAAR() As DataTable
        ...
        Try
            ...
            stConsultaSQL += "FROM "
            stConsultaSQL += "TARIRAAR, MANT_DEPARTAMENTO, MANT_MUNICIPIO, MANT_CLASSECT, VIGENCIA, MANT_ESTRATO, MANT_DESTECON "

            stConsultaSQL += "WHERE "
            stConsultaSQL += "TARADEPA = DEPACODI AND "
            stConsultaSQL += "TARADEPA = MUNIDEPA AND "
            stConsultaSQL += "TARAMUNI = MUNICODI AND "
            stConsultaSQL += "TARACLSE = CLSECODI AND "
            stConsultaSQL += "TARAVIGE = VIGECODI AND "
            stConsultaSQL += "TARADEEC = DEECCODI AND "
            stConsultaSQL += "TARAESTR = ESTRCODI "

            stConsultaSQL += "ORDER BY "
            stConsultaSQL += "TARADEPA, TARAMUNI, TARAVIGE, TARACLSE, TARADEEC "
        ...
        Catch ex As Exception
            MessageBox.Show(Err.Description & " " & "fun_Consultar_TARIRAAR")
            Return Nothing
        End Try
    ...
    ''' </summary>
    Public Function fun_Consultar_CAMPOS_TARIRAAR() As DataTable
        ...
        Catch ex As Exception
            MessageBox.Show(Err.Description & " " & "fun_Consultar_CAMPOS_TARIRAAR")
            Return Nothing
        End Try
    ...
    ''' esta funcion se llama desde el procedimiento "pro_inicializarControles()".
    ''' </summary>
    Public Function fun_Consultar_TARIRAAR_X_ESTADO() As DataTable
        ...
        Catch ex As Exception
            MessageBox.Show(Err.Description & " " & "fun_Consultar_TARIRAAR_X_ESTADO")
            Return Nothing
        End Try
    ...
    ''' </summary>
    Public Function fun_Buscar_ID_TARIRAAR(ByVal inTARAIDRE As Integer) As DataTable
        ...
        Catch ex As Exception
            MessageBox.Show(Err.Description & " " & "fun_Buscar_ID_TARIRAAR")
            Return Nothing
        End Try
    ...
    ''' </summary>
    Public Function fun_Buscar_CODIGO_DEPA_MUNI_CLSE_VIGE_DEEC_ESTR_AVIN_AVFI_X_TARIRAAR(ByVal stTARADEPA As String, _
                                                                          ByVal stTARAMUNI As String, _
                                                                          ByVal inTARACLSE As Integer, _
                                                                          ByVal inTARAVIGE As Integer, _
                                                                          ByVal inTARADEEC As Integer, _
                                                                          ByVal inTARAESTR As Integer, _
                                                                          ByVal inTARAAVIN As Integer, _
                                                                          ByVal inTARAAVFI As Integer) As DataTable
        ...
        Try
            ...
            stConsultaSQL += "TARAAVIN = '" & CInt(inTARAAVIN) & "' and "
            stConsultaSQL += "TARAAVFI = '" & CInt(inTARAAVFI) & "' "
        ...
        Catch ex As Exception
            MessageBox.Show(Err.Description & " " & "fun_Buscar_CODIGO_TARIRAAR")
            Return Nothing
        End Try
    ...
    ''' guarden registros duplicados.
    ''' </summary>
    Public Function fun_Buscar_CODIGO_DEPA_MUNI_CLSE_VIGE_DEEC_X_TARIRAAR(ByVal stTARADEPA As String, _
                                                                          ByVal stTARAMUNI As String, _
                                                                          ByVal inTARACLSE As Integer, _
                                                                          ByVal inTARAVIGE As Integer, _
                                                                          ByVal stTARADEEC As String) As DataTable
        ...
        Try
            ...
            stConsultaSQL += "TARACLSE = '" & CInt(inTARACLSE) & "' and "
            stConsultaSQL += "TARAVIGE = '" & CInt(inTARAVIGE) & "' and "
            stConsultaSQL += "TARADEEC = '" & CStr(Trim(stTARADEEC)) & "' "
    ...
    ''' guarden registros duplicados.
    ''' </summary>
    Public Function fun_Buscar_CODIGO_DEPA_MUNI_CLSE_VIGE_X_TARIRAAR(ByVal stTARADEPA As String, _
                                                                     ByVal stTARAMUNI As String, _
                                                                     ByVal inTARACLSE As Integer, _
                                                                     ByVal inTARAVIGE As Integer) As DataTable
    ...
    ''' parametrizada.
    ''' </summary>
    Public Function fun_Buscar_ID_X_CONSULTA_PARAMETRIZADA_TARIRAAR(ByVal inTARAIDRE As Integer) As DataTable
        ...
        Catch ex As Exception
            ...
            MessageBox.Show(Err.Description & " " & "fun_Buscar_ID_X_CONSULTA_PARAMETRIZADA_TARIRAAR")
            Return Nothing
